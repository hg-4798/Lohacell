	...
	<div class="cartOrder-page">
		...
		<article class="cart-order-wrap">
			...
			<div class="orderEnd-result mt-80">
				...
				<p class="point-color">주문번호 : 12365498754ABC</p>
			</div>
				...
				<table class="th-top">
					...
					<tbody>
						<tr>
							...
							<td class="txt-toneA fz-13">결제완료</td>
						</tr>
						<tr>
							<td class="pl-25">
								<div class="goods-in-td">
							...
							<td class="flexible-delivery">
								<div class="with-question">
									...
									<div class="question-btn">
										<i class="icon-question">배송설명</i>
										<div class="comment">선택하신 매장을 방문하여 입어보고 수령하시면 됩니다.  (재고가 있을 경우 : 당일~3일 이내 방문수령 / 재고가 없을 경우 : 3일~5일 이내 방문수령)</div>
									</div>
								</div>
								<strong class="txt-toneA">\3,000</strong><div class="pt-5">VIKI 강남역점</div>
							</td>
						...
						<tr>
							...
							<td class="flexible-delivery">
								<div class="with-question">
									...
									<div class="question-btn">
										<i class="icon-question">배송설명</i>
										<div class="comment">본사물류 또는 해당 브랜드 매장에서 택배로 고객님께 상품이 배송됩니다. (주문 완료 후, 3~5일 이내 수령)</div>
									</div>
								</div>
								<strong class="txt-toneA">\3,000</strong><div class="pt-5">VIKI 강남역점</div>
							</td>
