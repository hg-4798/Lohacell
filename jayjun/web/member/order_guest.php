			...
			<div class="frm-box mt-50 with-inner">
					...
					<section>
						...
						<form class="login-reg mt-20">
							<fieldset>
								...
								<div class="mt-10"><button class="btn-line w100-per h-large" type="submit"><span>비회원 구매하기</span></button></div>
							</fieldset>
						</form>
					</section>
					<section class="mt-40">
				...
				<div class="inner pl-80 pr-80">
					<section class="join-benefit total">
						...
						<dl>
							<dt class="title">통합회원 전환</dt>
							<dd>신원 오프라인 매장의 회원이세요?</dd>
							<dd>신원 통합회원으로 전환시 <strong class="point-color">20,000 E포인트를</strong>즉시 증정합니다.</dd>
						</dl>
