...
*/
	...
	if( page_checker() != -1 ){
	 ...
	 function page_checker(){
		var Arr_location  = [
			"/jayjun/web/brand/brand_about.php",
			"/jayjun/web/brand/brand_store.php",
			"/jayjun/web/brand/brand_eCatalog.php",
			"/jayjun/web/brand/brand_lookbook.php",
			"/jayjun/web/brand/brand_lookbook_view.php",
			"/jayjun/web/goods/brand_goods_list.php"
		]; // check할 해당 page
