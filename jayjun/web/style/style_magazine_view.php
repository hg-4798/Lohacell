...
<div id="contents">
	<div class="style-page">
		...
		<article class="style-wrap">
			<header><h2 class="style-title">매거진</h2></header>
			<div class="style-view">
				...
				<div class="editor-output">
					<p><img src="../static/img/test/@magazine_view1100.jpg" alt=""></p>
					<p></p>
					<p></p>
					<p style="color:#000; font-size:13px">패치하세요~</p>
					<p style="color:#555; font-size:13px;">와펜이나 브로치를 어지럽게 붙인 가방은 하나쯤 장만해두어도 좋다. 유행이 지나면 와펜은 떼어내면 그만이니까. 하지만 진짜 와펜보다는 그런 것처럼 보이는 가방이 유행이다. </p>
					<p>스티커를 붙인 트렁크에서 영감 받은 루이 비통의 가방이 바로 그것.</p>
					<p></p>
					<p style="color:#000; font-size:13px">1.MCM</p>
					<p style="color:#555; font-size:13px">소가죽 소재 백팩은 1백만원대.</p>
					<p></p>
					<p style="color:#000; font-size:13px">2. 루이비통</p>
					<p style="color:#555; font-size:13px">에피 소가죽 소재 가방은 6백만원대</p>
				</div>
