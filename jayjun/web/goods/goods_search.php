...
<div id="contents">
	...
	<div class="search-form">
		<p class="fz-14"><strong class="point-color">'코트'</strong>의 검색결과 <strong class="point-color">총 5개</strong>입니다.</p>
		<form class="mt-20">
			<fieldset>
				...
				<input type="text" class="w350 ml-15" title="검색어 입력자리" placeholder="코트">
		...
		<article class="clear">
			...
			<div class="goods-list-wrap">
				<div class="goods-sort clear">
					...
					<div class="sort-by ">
						<label for="sort_by12">Sort by</label>
						<div class="select">
							<select id="sort_by12">
								<option>신상품순</option>
								<option>높은가격순</option>
