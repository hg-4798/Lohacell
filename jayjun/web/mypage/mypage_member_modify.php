			...
			<article class="my-content">
				...
				<fieldset>
					...
					<table class="th-left mt-10">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="input-cover">
										<input type="password" style="width:270px" id="mbReg_pw2" title="비밀번호 재입력자리" placeholder="비밀번호 재입력">
									</div>
								</td>
							</tr>
							<tr>
					...
					<div class="btnPlace mt-40">
						<button type="submit" class="btn-point h-large w250"><span>확인</span></button>
					</div>
				</fieldset>
