...
<main id="content" class="subpage">
	...
	<section class="pop_layer layer_goods_detail">
		<div class="inner">
			...
			<ul class="goods_information">
				<li>
					<div class="type">제품소재</div>
					<div class="content">[겉감]폴리에스터100%/[안감]폴리에스터100%</div>
				</li>
				<li>
					<div class="type">색상</div>
					<div class="content">BL</div>
				</li>
				<li>
					<div class="type">치수</div>
					<div class="content">95/100/105/110</div>
				</li>
				<li>
					<div class="type">제조자</div>
					<div class="content">(주)신원</div>
				</li>
				<li>
					<div class="type">제조국</div>
					<div class="content">필리핀</div>
				</li>
				<li>
					<div class="type">세탁방법 및 취급시 주의사항</div>
					<div class="content">본 제품은 반드시 드라이크리닝 하십시오.(세탁라벨참고)</div>
				</li>
				<li>
					<div class="type">제조연월</div>
					<div class="content">2017.03</div>
				</li>
				<li>
					<div class="type">품질보증기준</div>
					<div class="content">제품 이상 시 공정거래위원회 고시 소비자분쟁해결기준에 의거 보상합니다.</div>
				</li>
				<li>
					<div class="type">A/S 책임자와 전화번호</div>
					<div class="content">(주)신원 1661-2585</div>
				</li>
			</ul>
		</div>
	</section>
				...
				<div class="list_review">
					<ul class="list_board">
						...
						<li>
							...
							<div class="con_area">
								<div class="review_txt">
									<div class="body_info">키 <strong>160cm</strong>, 몸무게 <strong>54kg</strong> 의 고객이 <strong>L</strong>사이즈로 주문하였습니다.</div>
									이번에 새로 구입했는데 정말 좋네요.<br>선물로 강추해요!
									<div class="btns">
										<a href="javascript:;" class="btn_review_write btn-line">수정</a>
										<a href="javascript:;" class="btn-basic">삭제</a>
					...
					<div class="select_shipping" data-ui="TabMenu">
						...
						<div class="wrap_tabmenu">
							<ul class="tab-menu clear">
								...
								<li data-content="menu"><label><input type="radio" class="radio_def" name="shipMethod"> 당일수령</label></li>
								<li data-content="menu"><label><input type="radio" class="radio_def" name="shipMethod"> 매장픽업</label></li>
							</ul>
