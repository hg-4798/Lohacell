...
<main id="content" class="subpage">
	...
	<section class="photo_type_view">
		<h4 class="title_area"><span class="tit">2016 신상 컬렉션</span> <span class="date">2017.01.14</span></h4>
		<div class="img_area">
			<div class="img"><img src="static/img/test/@catalog_view01.jpg" alt="E-CATALOG 이미지"></div>
		...
		<div class="btns">
			<ul>
				<li><a href="brand_catalog.php" class="icon_list">목록</a></li>
