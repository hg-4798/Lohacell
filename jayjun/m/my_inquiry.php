...
<main id="content" class="subpage">
	...
	<section class="pop_layer layer_inquiry_write">
		<div class="inner">
			<h3 class="title">1:1문의<button type="button" class="btn_close">닫기</button></h3>
					...
					<ul class="accordion_list">
						<li>
							<div class="my_inquiry">
								<p class="info"><strong>회원가입</strong><span class="date">2017.01.20</span></p>
								<p class="tit accordion_btn">궁금하고 또 궁금해서 물어보는데요. 꼭 답변주실 수 있으신거죠? 네? 네?</p>
							</div>
							<div class="qna_con accordion_con">
								<div class="question">
									<p class="txt">너무 마음에 들어 사이즈 문의합니다.<br>오늘안으로 답변 주실 수 있나요? </p>
									<div class="btns">
										<a href="javascript:;" class="btn_inquiry_write btn-line">수정</a>
						...
						<li>
							<div class="my_inquiry">
								<p class="info"><strong>로그인 회원가입</strong><span class="date">2017.01.20</span></p>
						...
						<li>
							<div class="my_inquiry">
								<p class="info"><strong>주문배송</strong><span class="date">2017.01.20</span></p>
								<p class="tit accordion_btn">궁금하고 또 궁금해서 물어보는데요. </p>
							</div>
							<div class="qna_con accordion_con">
								<div class="question">
			...
			<div class="tab-content" data-content="content"><!-- [D] 통합포인트와 구성 동일 -->
				...
				<div class="inquiry_list mt-10">
					<ul class="accordion_list">
						...
						<li>
							<div class="my_inquiry">
								<p class="info"><strong>로그인</strong><span class="date">2017.01.20</span></p>
								<p class="tit accordion_btn">궁금하고 또 궁금해서 물어보는데요.</p>
							</div>
							<div class="qna_con accordion_con">
								<div class="question">
