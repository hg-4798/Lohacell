...
<main id="content" class="subpage">
	<section class="page_local">
		...
		<div class="breadcrumb">
			<ul class="depth2">
				<li>
					<a href="javascript:;">이메일 무단 수집거부</a>
					<ul class="depth3">
						<li><a href="agreement.php">이용약관</a></li>
						<li><a href="privacy.php">개인정보취급방침</a></li>
						<li><a href="emailpolicy.php">이메일 무단 수집거부</a></li>
					</ul>
				</li>
			</ul>
	...
	<section class="wrap_privacy">
		...
		<div class="box_txt mt-15">
			<strong>정보통신망법 제50조의2 (전자우편주소의 무단 수집행위 등 금지)</strong><br>
			- 누구든지 전자우편주소의 수집을 거부하는 의사가 명시된 인터넷 홈페이지에서 자동으로 전자 우편주소를 수집하는 프로그램 그 밖의 기술적 장치를 이용하여 전자우편주소를 수집하여서는 아니 된다. <br>
