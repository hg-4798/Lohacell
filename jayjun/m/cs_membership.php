...
<main id="content" class="subpage">
	...
	<section class="my_membership sub_bdtop">
		<div class="info_msg">
			<h3>신원몰 통합 멤버쉽 안내</h3>
			<p class="txt">신원 통합 멤버쉽 회원이 되시면 온라인 공식몰과 오프라인 매장에서 상품 구매시 사용할 수 있는 다양한 쿠폰 및 포인트를 제공합니다.</p>
		</div>
		...
		<div class="list_bnf">
			...
			<ul>
				...
				<li>
					...
					<div class="content">
						<p class="tit point-color">20,000 E포인트 적립</p>
		...
		<div class="membership_bnf mt-30">
			...
			<table class="th-top mt-10">
				...
				<tbody>
					...
					<tr>
						<td class="bdb2 bg">회원가입 10,000 E포인트 +<br>앱 설치시 10,000 E포인트 제공</td>
					</tr>
				</tbody>
			</table>
			<ul class="ment">
					...
					<tr>
						...
						<td class="bdb2">
							<ul class="list">
								...
								<li>회원가입 1만 E포인트 + <br>앱설치 1만 E포인트 중복 지급 불가</li>
							</ul>
						</td>
					</tr>
					<tr>
		...
		<div class="bundle mt-25">
			<h3 class="tit">신원몰 회원님만의 특별한 혜택</h3>
			<div class="wrap_list">
				<ul class="bnf_list clear">
					<li>
						<div>
							<span class="icon"><img src="static/img/icon/icon_bnf_join.png" alt="회원가입 시 10,000 P 적립"></span>
							<span class="txt">회원가입 시 <br><strong>10,000 P 적립</strong></span>
						</div>
					</li>
					<li>
						<div>
							<span class="icon"><img src="static/img/icon/icon_bnf_login.png" alt="APP 첫 로그인 시 10,000 P 적립"></span>
							<span class="txt">APP 첫 로그인 시 <br><strong>10,000 P 적립</strong></span>
						</div>
					</li>
					<li class="fullw">
						<div>
							<span class="icon"><img src="static/img/icon/icon_bnf_check.png" alt="신원몰에 매일 30일 연속 출석체크 시 10,000 P 적립"></span>
							<span class="txt">신원몰에 매일 30일 연속 출석체크 시 <br><strong>10,000 P 적립</strong></span>
						</div>
					</li>
				</ul>
			</div>
