...
<main id="content" class="subpage">
	...
	<section class="photo_type_view">
		...
		<div class="editor_area">
			<img src="static/img/test/@magazine_view01.jpg" alt="매거진 이미지">
			<p>패치하세요~<br>와펜이나 브로치를 어지럽게 붙인 가방은 하나쯤 장만해 두어도 좋다. 유행이 지나면 와펜은 떼어내면 그만이니까. 하지만 진짜 와펜보다는 그런 것처럼 보이는 가방이 유행이다. 스티커를 붙인 트렁크에서 영감 받은 루이 비통의 가방이 바로 그것.<br><br>
			1. MCM<br>
			소가죽 소재 백팩은 1백만원대.<br>
			<br>
			2. 루이비통<br>
			에피 소가죽 소재 가방은 6백만원대</p>
		</div><!-- //.editor_area -->

		<div class="btns mt-20">
			<ul>
				<li><a href="style_magazine.php" class="icon_list">목록</a></li>
