...
<main id="content" class="subpage">
	...
	<section class="wrap_inactive sub_bdtop">
		<div class="notice">
			...
			<p class="txt">개인정보 보호를 위해 1년 이상 구매 또는 로그인 이력이<br> 없으신 회원님의 개인정보는 별도 보관 처리 됩니다. <br>로그인을 원하실 경우, 아래 동의 버튼을 누르시면 <br>휴면 해제 됩니다.</p>
		</div>

		<div class="inactive_agree">
			<ul class="wrap_btn">
				<li><a href="javascript:;" class="btn-point">동의</a></li>
				<li><a href="javascript:;" class="btn-line">미동의</a></li>
			</ul>
		</div>
