	...
	?> -->
	 ...
	 <div class="container960">
		...
		<h3 class="title mt_20">
				회원가입
				<p class="line_map"><a><img src="../img/icon/home.gif" alt="" /> 홈</a> &gt; <a>약관/본인인증</a> &gt; <a class="on">회원정보입력</a> &gt; <a>가입완료</a></p>
			</h3>
		<form name="createUserForm" method="post" action="">
			...
			<div class="table_wrap mt_30">
				...
				<table class="th_left" summary="회원가입 정보를 입력합니다.">
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<a href="javascript:;" id="btnCheckId"><img src="../img/button/btn_id_check.gif" alt="" /></a> <span class="reg_ment">아이디는 4자 이상 10자 이하의 영문자,숫자 조합만 가능합니다.</span>
							</td>
						</tr>
						<tr>
					...
					<?}?>
						<tr>
							<th scope="row"><div class="ml_5">전화번호</div></th>
							<td>
						...
						<tr>
							...
							<td>
								...
								<a href="javascript:;" id="btnCheckEmail"><img src="../img/button/btn_dupli_check.gif" alt="" /></a>
								<input type="hidden" name="email" />
								<input type="hidden" id="email_check" value="0" />
							</td>
						</tr>
						<tr>
							<th scope="row"><div class="ml_5">이메일/SMS <br />수신여부</div></th>
							<td>
								<ul>
									<li>엑스넬스에서 제공되는 서비스에 대한 수신동의 여부를 확인해 주세요.</li>
									<li class="mt_5">
			...
			<div class="ta_c mt_40 mb_80">
				<a href="javascript:CheckForm('<?=$mem_type?>');"><img src="../img/button/btn_join.gif" alt="회원 가입" /></a> <a href="/front/member_join.php?mem_type=<?=$mem_type?>"><img src="../img/button/cart_order_cancel_btn.gif" alt="취소 하기" /></a>
			</div>
			<!-- //가입버튼 -->
		</form>
	 </div>
