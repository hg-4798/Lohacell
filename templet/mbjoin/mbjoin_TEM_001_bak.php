...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%"  class="th_left_st">
			...
			<tr>
			<td colspan=4 class="pd_none"><h2 class="info_type">기본정보 입력</h2></td>
			</tr>
			<tr>
			...
			<tr>
				<th><font color="#F02800"><b>＊</b></font><font color="#000000"><b>생년월일</b></font></th>
				<td>
					<?if($strDateBirth){?>
			...
			<tr>
				...
				<td colspan="3" class="pd_none">
				<table cellpadding="0" cellspacing="0" width="100%" style="style_none">
				<tr>
					<td>
						<INPUT type=text name="home_post1" value="<?=$home_post1?>" readOnly style="WIDTH:40px;BACKGROUND-COLOR:#F7F7F7;" class="input"> - 
						<INPUT type=text name="home_post2" value="<?=$home_post2?>" readOnly style="WIDTH:40px;BACKGROUND-COLOR:#F7F7F7;" class="input">
						<a href="javascript:f_addr_search('form1','home_post','home_addr1',2);">
							<img src="<?=$Dir?>images/common/mbjoin/<?=$_data->design_mbjoin?>/memberjoin_skin1_btn2.gif" border="0" align="absmiddle" hspace="3">
						</a>
					</td>
				</tr>
				<tr>
...
?>
			<tr>
			<td colspan=4><h2 class="info_type">사업자정보 입력</h2></td>
			</tr>
			<tr>
...
<?
	...
	<tr>
		<td align="center"><a href="javascript:CheckForm('<?=$mem_type?>');" class="btn_buy">회원가입하기</a><a href="javascript:history.go(-1);";  class="btn_gray">다시작성하기</td>
	</tr>
	<tr>
		<td height="20"></td>
	</tr>
