		...
		<div class="inner-align page-frm clear">
			...
			<article class="my-content member-grade">
				...
				<div class="point-info clear">
					...
					<dl>
						<dt><img src="/jayjun/web/static/img/icon/icon_my_point_big.png" alt="통합 포인트">통합 포인트</dt>
						<dd class="fz-16">현재 통합 포인트<br><strong class="fz-22 point-color"><?=number_format($_mdata->reserve) ?>P</strong></dd>
					</dl>
					<dl>
						<dt><img src="/jayjun/web/static/img/icon/icon_my_epoint_big.png" alt="E통합 포인트">현재 E포인트</dt>
						<dd class="fz-16">현재 E포인트<br><strong class="fz-22 point-color"><?=number_format($_mdata->act_point) ?>P</strong></dd>
					</dl>
				</div>
				<p class="pt-10 fz-13">*통합포인트: 오프라인 매장, <?=$_data->shopname?>몰에서 모두 사용이 가능한 포인트</p>
				<p class="pt-5 fz-13">*E포인트: <?=$_data->shopname?>몰에서만 사용이 가능한 온라인 전용 포인트</p>
				...
				<table class="th-left mt-15">
					...
					<thead>
						<tr>
							<th scope="col">브랜드</th>
							<th scope="col">상품 할인율(TAG가 기준)</th>
