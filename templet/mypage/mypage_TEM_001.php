			...
			<article class="my-content">
				<div class="my-grade-summary clear">
					<div class="info-grade">
						<span class="fw-bold pr-5 point-color"><?=$_mdata->name?></span>님의 회원등급 <strong><?=$mem_grade_text?></strong>
					...
					<div class="progress">
						...
						<dl>
							<dt><i><img src="/jayjun/web/static/img/icon/icon_my_coupon.png" alt="쿠폰"></i><span>내쿠폰</span></dt>
							<dd class=""><?=$coupon_cnt?></dd>
						</dl>
						</a>
						<a href="<?=$Dir.FrontDir?>mypage_act_point.php">
						<dl>
							<dt><i><img src="/jayjun/web/static/img/icon/icon_my_mileage.png" alt="마일리지"></i><span>마일리지</span></dt>
							<dd class=""><?=number_format($reserve)?>M</dd>
						</dl>
						</a>
						<a href="<?=$Dir.FrontDir?>mypage_act_point.php">
						<dl>
							<dt><i><img src="/jayjun/web/static/img/icon/icon_my_point.png" alt="포인트"></i><span>포인트</span></dt>
							<dd class=""><?=number_format($act_point)?>P</dd>
						</dl>
						</a>
						<a href="<?=$Dir.FrontDir?>mypage_orderlist.php">
						<dl>
							<dt><i><img src="/jayjun/web/static/img/icon/icon_my_delivery_ing.png" alt="배송중"></i><span>배송중</span></dt>
							<dd class=""><?=number_format($osc_data->step3)?></dd>
						</dl>
						</a>
						<a href="<?=$Dir.FrontDir?>mypage_orderlist.php">
						<dl>
							<dt><i><img src="/jayjun/web/static/img/icon/icon_my_delivery_end.png" alt="배송완료"></i><span>배송완료</span></dt>
							<dd class=""><?=number_format($osc_data->step4)?></dd>
						</dl>
						</a>
						<a href="<?=$Dir.FrontDir?>mypage_cancellistnow.php">
						<dl>
							<dt><i><img src="/jayjun/web/static/img/icon/icon_my_delivery_refund.png" alt="취소/교환/반품"></i><span>취소/교환/반품</span></dt>
							<dd class=""><?=number_format($osc_data->step5+$osc_data->step6+$osc_data->step7)?></dd>
						</dl>
						</a>
					</div>
