	...
	<tr>
		...
		<tr>
			...
			<tr>
				...
				<tr>
					<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_tabel01.gif" border="0"></td>
				</tr>
				<tr>
					<td background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_tabel01bg.gif" style="padding-top:10px;">
				...
				<tr>
					<td background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_tabel01bg.gif"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_tabel01down.gif" border="0"></td>
				</tr>
				</table>
				</td>
				<td width="50%" align="right" valign="top">
					...
					<tr>
						<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_tabel02.gif" border="0"></td>
					</tr>
					<tr>
						<td background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_tabel01bg.gif" style="padding-top:10px;padding-left:15px;">
						<table cellpadding="0" cellspacing="0" width="100%">
						<col width="6"></col>
						<col width="49"></col>
						<col width="5"></col>
						...
						<tr style="letter-spacing:-0.5pt;">
							<td><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_tabelpoint.gif" border="0"></td>
					...
					<tr>
						<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_tabel02down.gif" border="0"></td>
					</tr>
					</table>
				</td>
			</tr>
...
?>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin3_t1.gif" border="0"></td>
				<td width="100%" background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin3_t1bg.gif"></td>
				<td><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin3_t4.gif" border="0"></td>
			</tr>
			<tr>
				<td background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin3_t2bg.gif"></td>
				...
				<td background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin3_t4bg.gif"></td>
			</tr>
			<tr>
				<td><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin3_t2.gif" border="0"></td>
				<td width="100%" background="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin3_t3bg.gif"></td>
				<td><img src="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/design_search_skin3_t3.gif" border="0"></td>
			</tr>
			</table>
			</td>
		</tr>
...
?>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_text01.gif" border="0"></td>
			<td align="right" style="padding-bottom:3px;"><A HREF="<?=$Dir.FrontDir?>mypage_orderlist.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_btn01.gif" BORDER="0"></A></td>
		</tr>
		</table>
		</td>
	</tr>
	<tr>
		...
		<col width="60"></col>
		<tr>
			<td height="2" colspan="7" bgcolor="#13A0DA"></td>
		</tr>
...
?>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_text02.gif" border="0"></td>
			<td align="right" style="padding-bottom:3px;"><A HREF="<?=$Dir.FrontDir?>mypage_personal.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_btn01.gif" BORDER="0"></A></td>
		</tr>
		</table>
		</td>
	</tr>
	<tr>
		...
		<col width="105"></col>
		<tr>
			<td height="2" colspan="4" bgcolor="#13A0DA"></td>
		</tr>
		<tr height="30" align="center" bgcolor="#F8F8F8" style="letter-spacing:-0.5pt;">
...
?>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_text03.gif" border="0"></td>
			<td align="right" style="padding-bottom:3px;"><A HREF="<?=$Dir.FrontDir?>wishlist.php"><IMG SRC="<?=$Dir?>images/common/mypage/<?=$_data->design_mypage?>/mypage_skin3_btn01.gif" BORDER="0"></A></td>
		</tr>
		</table>
		</td>
	</tr>
