...
<div class="main_wrap">
	...
	<? include $Dir.FrontDir."mypage_menu.php";?>
		...
		<div class="my_order_detail">
             ...
             <div class="recently_orderlist_title">
			 <span class="recently_orderlist_titleimg"><img src="<?=$Dir?>image/mypage/order_detail_title.gif" alt="최근주문내역" /></span>
			 ...
			 <span class="recently_orderlist_more"><a href="mypage_orderlist.php"><img src="<?=$Dir?>image/mypage/bt_more.gif" alt="more" /></a></span>
			 </div>

             <div class="recently_orderlist_warp">

             <div class="recently_orderlist_bar">
			 <ul>
			 <li class="cell20"><img src="<?=$Dir?>image/mypage/order_detail_menu01.gif" alt="주문일시" /></li>
			 <li class="cell15"><img src="<?=$Dir?>image/mypage/order_detail_menu02.gif" alt="주문번호" /></li>
			 <li class="cell15"><img src="<?=$Dir?>image/mypage/order_detail_menu03.gif" alt="결제방법" /></li>
			 <li class="cell10"><img src="<?=$Dir?>image/mypage/order_detail_menu04.gif" alt="주문금액" /></li>
			 <li class="cell10"><img src="<?=$Dir?>image/mypage/order_detail_menu05.gif" alt="주문상태" /></li>
			 <li class="cell15"><img src="<?=$Dir?>image/mypage/order_detail_menu06.gif" alt="수령확인" /></li>
			 <li class="cell15"><img src="<?=$Dir?>image/mypage/order_detail_menu09.gif" alt="영수증신청" /></li>
			 </ul>
			 </div>

			 <div class="recently_orderlist_list">
<?
...
/*
		...
		$paging = new Tem001_Paging($sql,10,4,'GoPage',true);
...
?>
			...
			<ul>
			 <li class="cell20"><?=$row->ord_date?> <?=$ord_time?></li>
			...
			<?
			 ...
			 <li class="cell15"><?if($row->receipt_yn!="N" && $row->ordertype=="2"){?><A HREF="javascript:OrderDetail('<?=$row->ordercode?>')"><img src="<?=$Dir?>image/mypage/bt_receipt_request.gif" alt="영수증신청" /></a><?}?></li>
			 </ul>
...
?>
			 ...
			 </div><!-- recently_orderlist_list 끝 -->

			 </div><!-- recently_orderlist_warp 끝 -->
		...
		<div class="my_writelist">
			<div class="my_articlelist">
					<table style="background:url(<?=$Dir?>image/mypage/sub_title_bg.gif) no-repeat 10px 35px;">
						  <tr>
							<td height="33" colspan="3" >
								<table>
								  <tr>
									<td width="280" height="33" align="left"><img src="<?=$Dir?>image/mypage/my_article_title.gif" alt="내가 작성한 최근글" /></td>
									<td width="60" align="center"><a href="<?=$Dir.FrontDir?>mypage_myWrite.php" ><img src="<?=$Dir?>image/mypage/bt_more.gif" alt="more" /></a></td>
								  </tr>
								</table>
							</td>
						  </tr>
...
<?
				...
				$sql = "SELECT board,title,writetime,num FROM tblboard ";
				$sql.= "WHERE mem_id='".$_ShopInfo->getMemid()."' and pos=0 and depth=0 ";
...
?>
						<tr>
							...
							<td width="280" align="left"><a href="<?=$Dir.BoardDir?>board.php?pagetype=view&num=<?=$row->num?>&board=<?=$row->board?>&block=&gotopage=1&search=&s_check="><?=$row->title?></a></td>
							<td width="90" align="center"><span><?=$date?></span></td>
					 	</tr>
...
<?
			...
			$cnt++;}
				if ($cnt==0) {?>
							...
							<tr height="89"><td colspan="3" align="center">문의내역이 없습니다.</td></tr>
<?				}?>


					</table>
			</div><!--my_articlelist 끝  -->

			<div class="my_replylist">
			<table style="background:url(<?=$Dir?>image/mypage/sub_title_bg.gif) no-repeat 10px 35px;">
						  <tr>
							<td height="33" colspan="3">
							...
							<table>
							  <tr>
								<td width="280" height="33" align="left"><img src="<?=$Dir?>image/mypage/my_reply_title.gif" alt="내가 작성한 최근 댓글" /></td>
								<td width="60" align="center"><a href="<?=$Dir.FrontDir?>mypage_myReply.php"><img src="<?=$Dir?>image/mypage/bt_more.gif" alt="more" /></a></td>
							  </tr>
							</table></td>
							</tr>
						  <tr>
			...
			<div class="right_section">
				...
				<div class="right_article_wrap">
					<div class="right_article">
						...
						<!-- 주소복사 -->
						<p class="local_copy"><span><a href="<?=$Dir.MainDir?>main.php">홈</a> > 마이페이지</span></p>
						<!-- #주소복사 -->
				...
				<?
						...
						while($row=pmysql_fetch_object($result)) {
							...
							echo "	<td align=center><A HREF=\"javascript:OrderDetailPop('".$row->ordercode."')\" onmouseover=\"window.status='주문내역조회';return true;\" onmouseout=\"window.status='';return true;\" class=\"btn_search02\">조회</A></td>\n";
							echo "</tr>\n";
							$cnt++;
						}
						pmysql_free_result($result);
