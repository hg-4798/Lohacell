...
if (strpos($_SERVER["REQUEST_URI"],'brand_detail.php') !== false) {					// BRAND 페이지
	$cate_type_code	= "BD";
} else if (strpos($_SERVER["REQUEST_URI"],'productlist_sw.php') !== false) {			// 카테고리 상품 리스트 페이지
	$cate_type_code	= "PL";
} else if (strpos($_SERVER["REQUEST_URI"],'productsearch_sw.php') !== false) {		// 상품 검색 리스트 페이지
	$cate_type_code	= "PS";
