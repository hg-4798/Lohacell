		...
		<div class="inner-align page-frm clear">
			...
			<article class="my-content order-detail">
				<ul class="order-flow clear">
					<li><i><img src="/jayjun/web/static/img/icon/icon_my_order_ok.png" alt="주문접수"></i><p>01.주문접수</p></li>
					<li><i><img src="/jayjun/web/static/img/icon/icon_my_payment_ok.png" alt="결제완료"></i><p>02.결제완료</p></li>
					<li><i><img src="/jayjun/web/static/img/icon/icon_my_delivery_ready.png" alt="배송준비"></i><p>03.배송준비</p></li>
					<li><i><img src="/jayjun/web/static/img/icon/icon_my_delivery_ing.png" alt="배송중"></i><p>04.배송중</p></li>
					<li><i><img src="/jayjun/web/static/img/icon/icon_my_delivery_end.png" alt="배송완료"></i><p>05.배송완료</p></li>
				</ul>
