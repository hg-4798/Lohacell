...
<!--					<input type="button" name="addrtype" value="과거 배송지" onclick="addrchoice()" style="border:none;">-->
				...
				<tr>
					...
					<input type="radio" name="deli_type" class="deli_type" value="1">추가주문/묶음배송<br><div class="pack"  style="text-align:left;width:97%"><img src="../image/cart/pack_txt.gif"></div></td>
			...
			<table class="form_use" width= cellpadding=0 cellspacing=0 border=0>
				...
				<tr>
					...
					<tr>
						<th>배송비</th>
						<td>
							<div class="order_price_style02">
								<span id=delivery_price><?=number_format($deli_price)?></span>원
							</div>
						</td>
					</tr>
					<tr>
...
?>
					...
					<tr>
						...
						<tr>
							<!-- ID_coupon_code_layer : 쿠폰 코드와 상품 코드 넘어오는레이어 -->
...
<?}?>
					...
					<tr>
						<th><a href="javascript:calcuPayment()">총 결제금액</a></th>
