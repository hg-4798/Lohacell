		...
		while($row = pmysql_fetch_object($result)) {
			...
			if($row->assemble_idx>0 && strlen(str_replace("","",$row->assemble_list))>0) {
				...
				while($alprorow=@pmysql_fetch_object($alproresult)) {
					...
					$assemble_str.="			<tr>\n";
					$assemble_str.="				<td style=\"padding:4px;word-break:break-all;\"><font color=\"#000000\"><b>".$alprorow->productname."</b></font>&nbsp;</td>\n";
...
<?
	...
	if($sumprice>0) {
		...
		echo "	<col width=></col>\n";
		echo "	<tr>\n";
		echo "		<td align=right bgcolor=#f0f0f0 style=\"padding-right:15\"><FONT COLOR=\"#976633\"><B>상품 합계금액</B></FONT></td>\n";
		echo "		<td align=right bgcolor=#ffffff style=\"padding-right:15\"><FONT COLOR=\"#976633\"><B>".number_format($sumprice)."원</B></FONT></td>\n";
		echo "	</tr>\n";
		if($_data->ETCTYPE["VATUSE"]=="Y") { 
			$sumpricevat = return_vat($sumprice);
			echo "	<tr>\n";
			echo "		<td align=right bgcolor=#f0f0f0 style=\"padding-right:15\"><FONT COLOR=\"#976633\"><B>부가세(VAT) 합계금액</B></FONT></td>\n";
			echo "		<td align=right bgcolor=#ffffff style=\"padding-right:15\"><FONT COLOR=\"#976633\"><B>+ ".number_format($sumpricevat)."원</B></FONT></td>\n";
			echo "	</tr>\n";
		}
		if($deli_price>0) {
			echo "	<tr>\n";
			echo "		<td align=right bgcolor=#f0f0f0 style=\"padding-right:15\"><FONT COLOR=\"#976633\"><B>배송비 합계금액</B></FONT></td>\n";
			echo "		<td align=right bgcolor=#ffffff style=\"padding-right:15\"><FONT COLOR=\"#976633\"><B>+ ".number_format($deli_price)."원</B></FONT></td>\n";
			echo "	</tr>\n";
		}
		if($salemoney>0) {
			echo "	<tr>\n";
			echo "		<td align=right bgcolor=#ffffff style=\"padding-right:15\"><img src=\"".$Dir."images/common/group_orderimg.gif\" align=absmiddle>&nbsp;&nbsp;<b><font color=#0000FF>".$group_name." 추가 할인</FONT></b></td>\n";
			echo "		<td align=right bgcolor=#ffffff style=\"padding-right:15\"><FONT COLOR=\"#0000FF\"><B>- ".number_format($salemoney)."원</B></FONT></td>\n";
			echo "	</tr>\n";
		}
		echo "	<tr>\n";
		echo "		<td align=right bgcolor=#f0f0f0 style=\"padding-right:15;font-size:17\"><FONT COLOR=\"#976633\"><B>총 결제금액</B></FONT></td>\n";
		...
		if($reserve>0 && $_data->reserve_maxuse>=0 && strlen($_ShopInfo->getMemid())>0) {
			echo "<tr>\n";
			echo "	<td align=right bgcolor=#f0f0f0 style=\"padding-right:15\"><FONT COLOR=#0099CC><B>적립금</B></FONT></td>\n";
...
?>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td valign="bottom"><IMG SRC="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_stitle3.gif" border="0" vspace="3" align="absmiddle"><input type=checkbox name="same" value="Y" onclick="SameCheck(this.checked)" style="border:none;"><font color="#F02800"><B>주문자 정보와 같음</font></B></td>
		</tr>
		<tr>
			<td height="2"></td>
		</tr>
...
<?
		...
		if($etcmessage[2]=="Y") {
			$tempmess.="<tr>\n";
			$tempmess.="	<td><font color=\"#F02800\"><b>무통장 입금시 입금자명</b></font></td>\n";
...
?>
	<tr>
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="1" bgcolor="#EDEDED" width="100%" height="100%">
			<tr>
				<td bgcolor="#FFFFFF" style="padding:10px;padding-right:20px;padding-left:20px;" valign="top">
				<table cellpadding="0" cellspacing="0" width="100%">
				<col width="140"></col>
				<col></col>
<?
