...
<!--					<input type="button" name="addrtype" value="과거 배송지" onclick="addrchoice()" style="border:none;">-->
				...
				<tr>
					<th>배송선택</th>
					<td class="select_deliv" ><input type="radio" name="deli_type" value="0" checked> 기본배송
					<input type="radio" name="deli_type" value="1">추가주문/묶음배송<div class="pack"><img src="../image/cart/pack_txt.gif"></div></td>
			...
			<table class="form_use" width= cellpadding=0 cellspacing=0 border=0>
				...
				<tr>
					...
					<tr>
						<th>회원할인</th>
						<td id='memberdc'>
						<p class="order_price_style01"><?=number_format($mem_dc_price)?></p> 원
						</td>
					</tr>
					<tr>
						<th>금액할인</th>
...
?>
					...
					<tr>
						...
						<tr>
							...
							<input type=text name=coupon_dc size=12 style="text-align:right" value=0 readonly> 원 
					...
					<tr>
						...
						<tr>
							...
							<?  }else if($user_reserve>=$_data->reserve_maxuse){?>
									...
									<input type=text  name="usereserve" size=12 style="text-align:right" value=0 onKeyUp="reserve_check('<?=$okreserve?>');"> 원
					...
					<caption>결제수단 선택</caption>
						<col width=100>
							<tr>
								...
								?>
										<input id="dev_payment1" name="dev_payment" type="radio" value="B" onclick="sel_paymethod(this);" /><label for="dev_payment1">무통장입금</label>
								<?
										}
									}
									//신용카드
								...
								?>
										<input id="dev_payment2" name="dev_payment" type="radio" value="C" onclick="sel_paymethod(this);" /><label for="dev_payment2">신용카드</label>
								<?
									}
								...
								?>
										<input id="dev_payment3" name="dev_payment" type="radio" value="V" onclick="sel_paymethod(this);" /><label for="dev_payment3">계좌이체</label>
								<?
										}
									}
									//가상계좌
								...
								?>
										<input id="dev_payment5" name="dev_payment" type="radio" value="O" onclick="sel_paymethod(this);" /><label for="dev_payment5">가상계좌</label>
								<?
										}
									}
								...
								?>
										<input id="dev_payment6" name="dev_payment" type="radio" value="Q" onclick="sel_paymethod(this);" /><label for="dev_payment6">에스크로</label>
								<?
										}
									}
									//휴대폰
								...
								?>
										<input id="dev_payment4" name="dev_payment" type="radio" value="M" onclick="sel_paymethod(this);" /><label for="dev_payment4">휴대폰</label>
								<?}?>
