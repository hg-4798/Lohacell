...
<tr>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td><h1 class="cart_title">주문상세내역</h1></td>
...
<?
	...
	if($sumprice>0) {
		...
		if($salereserve>0) {
			echo "	<tr>\n";
			echo "		<td align=right bgcolor=#ffffff style=\"padding-right:15\"><img src=\"".$Dir."images/common/group_orderimg.gif\" align=absmiddle>&nbsp;&nbsp;<b><font color=#FF3C00>".$group_name." 추가 적립</FONT></b></td>\n";
			echo "		<td align=right bgcolor=#ffffff style=\"padding-right:15\"><FONT COLOR=\"#FF3C00\"><B>".number_format($salereserve)."원</B></FONT></td>\n";
			echo "	</tr>\n";
		}
		echo "	</table>\n";
		echo "	</td>\n";
...
?>
		...
		<tr>
			<td><h1 class="cart_title">주문자정보 입력</h1></td>
		</tr>
		<tr>
			<td height="2"></td>
		</tr>
		<tr>
			<td>
				...
				<div class="bd_box_wrap">
					...
					<col></col>
					<tr>
						<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>주문자이름</b></font></th>
						<td>
	<?
	...
	?>
					...
					<tr>
						<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>전화번호</b></font></th>
					...
					<tr>
						<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>이메일</b></font></th>
		...
		<tr>
			<td valign="bottom"><h1 class="cart_title">배송정보 입력</h1></td>
		</tr>
		<tr>
			<td>
			...
			<tr>
				...
				<col></col>
				<tr>
					<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>받는사람이름</b></font></th>
					<td><input type=text name="receiver_name" size="15" maxlength="12" class="input" style="BACKGROUND-COLOR:#F7F7F7;"><input type=checkbox name="same" value="Y" onclick="SameCheck(this.checked)" style="border:none;"><font color="#0099CC"><B>주문자 정보와 같음</font></B></td>
				</tr>
				<tr>
					<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>전화번호</b></font></th>
				...
				<tr>
					<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>비상전화</b></font></th>
				...
				<tr>
					<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>주 소</b></font></th>
					<td>
...
<?
				if(count($arr_prlist)==1) {
					...
					echo "<tr>\n";
					echo "	<th><img src=\"".$Dir."images/common/order/".$_data->design_order."/order_skin_point.gif\" border=\"0\"><font color=\"#000000\"><b>주문메세지<br>&nbsp;&nbsp;(50자내외)</b></font></th>\n";
					echo "	<td>\n";
					...
					echo "	<table border=0 cellpadding=3 cellspacing=0 width=100% class=\"style_none\">\n";
					...
					while(list($key,$val)=each($arr_prlist)) {
						echo "<tr><td colspan=3 style=\"border-top:1px solid #ececec\"></td></tr>\n";
						echo "<tr>\n";
						echo "	<th><img src=\"".$Dir."images/common/order/".$_data->design_order."/order_skin_point.gif\" border=\"0\"><font color=\"#000000\"><b>주문메세지<br>&nbsp;&nbsp;(50자내외)</b></font>";
						if($yy==0) {
							echo "<div align=center style=\"padding-top:5px\"><A HREF=\"javascript:change_message(1)\"><font color=red>[통합 입력]</font></A></div>";
						}
						echo "	</th>\n";
						echo "	<td><table border=0 cellpadding=0 cellspacing=0 height=100% class=\"style_none\"><tr><td width=2 bgcolor=#eeeeee><img width=2 height=0></td></tr></table></td>\n";
						echo "	<td style=\"padding:10px 0px;padding-left:5;word-break:break-all;\">\n";
...
?>
				...
				<tr>
					<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>안내메세지</b></font></th>
					<td>
...
?>
		...
		<tr>
			<td><h1 class="cart_title">적립금 및 쿠폰선택</h1></td>
		</tr>
		<tr>
			<td>
...
<?
				if (strlen($_ShopInfo->getMemid())>0 && $_data->reserve_maxuse>=0 && $user_reserve!=0) {
					...
					echo "		<tr>\n";
					echo "			<th><img src=\"".$Dir."images/common/order/".$_data->design_order."/order_skin_point.gif\" border=\"0\"><font color=\"#000000\"><b>적립금 사용</b></font></th>\n";
					echo "			<td>\n";
					echo "			<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" class=\"style_none\">\n";
					if ($reserve_maxprice>$sumprice) {
						echo "		<tr>\n";
...
?>
				...
				<tr>
					<th><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_point.gif" border="0"><font color="#000000"><b>쿠폰 선택</b></font></th>
					<td>
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="style_none">
					<tr>
						<td><input type=text name="coupon_code" size="19" readonly style="BACKGROUND-COLOR:#F7F7F7;" class="input"> <A HREF="javascript:coupon_check()" onmouseover="window.status='쿠폰선택';return true;"><img src="<?=$Dir?>images/common/order/<?=$_data->design_order?>/order_skin_btn1.gif" border="0" align="absmiddle"></A></td>
					</tr>
					<tr>
...
?>
		...
		<tr>
			<td><h1 class="cart_title">총 결제금액</h1></td>
		</tr>
		<tr>
			<td height="2"></td>
		</tr>
		...
		<tr>
			<td valign="top" height="100%">
				...
				<input type="hidden" name="total_sum" value="<?=$p_price?>">
					...
					<col></col>
					<tr>
						<th align=center style="font:bold;">상품 금액</th>
						<th></th>
						<th align=center style="font:bold;">배송비</th>
						<th></th>
						<th align=center style="font:bold;">할인금액</th>
						<th></th>
						<th align=center style="font:bold; color=red">총 합계 금액</th>
					</tr>
					<tr>
		...
		<tr>
			<td><h1 class="cart_title">결제 수단 선택</h1></td>
		</tr>
		<tr>
			<td height="2"></td>
		</tr>
