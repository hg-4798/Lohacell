					...
					<div class="type id">
						<table class="th-left-util">
							...
							<tr>
								...
								<td><input type="text" class="input-def" name="id" id="user-id" maxlength="20" onblur="document.form1.passwd.focus(); "onkeypress="if(event.keyCode==13){CheckForm();}" title="아이디 입력자리"></td>
							</tr>
							<tr>
			...
			<div class="login_area">
				...
				<table class="login_form" width=650 cellpadding=0 cellspacing=0 border=0 align=center <?=$sel_hide["nonmember"]?>>
					...
					<tr>
						...
						<td><input type="text" class="id_pw" name="id" id="" maxlength="20" onblur="document.form1.passwd.focus(); "onkeypress="if(event.keyCode==13){CheckForm();}"></td>
