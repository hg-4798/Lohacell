...
?>
			<br><a href="javascript:CheckForm('del',<?=$formcount-1?>)"><IMG SRC="<?=$Dir?>images/common/basket/<?=$_data->design_basket?>/basket_skin2_btn4.gif" border="0" onMouseDown="eval('try{ _trk_clickTrace( \'SCO\', \'<?=$productname?>\' ); }catch(_e){ }');"></a></td>
		</tr>
<?
...
?>
	...
	<tr>
		...
		<col width=></col>
		<tr>
			<td align=right bgcolor=#f0f0f0 style="padding-right:15"><FONT COLOR="#976633"><B>상품 합계금액</B></FONT></td>
			<td align=right bgcolor=#ffffff style="padding-right:15"><FONT COLOR="#976633"><B><?=number_format($sumprice)?>원</B></FONT></td>
		</tr>
		<?if($_data->ETCTYPE["VATUSE"]=="Y") { 
		$sumpricevat = return_vat($sumprice);
		?>
		<tr>
			<td align=right bgcolor=#f0f0f0 style="padding-right:15"><FONT COLOR="#976633"><B>부가세(VAT) 합계금액</B></FONT></td>
			<td align=right bgcolor=#ffffff style="padding-right:15"><FONT COLOR="#976633"><B>+ <?=number_format($sumpricevat)?>원</B></FONT></td>
		</tr>
		<? } ?>
		<?if($deli_price>0){?>
		<tr>
			<td align=right bgcolor=#f0f0f0 style="padding-right:15"><FONT COLOR="#976633"><B>배송비 합계금액</B></FONT></td>
			<td align=right bgcolor=#ffffff style="padding-right:15"><FONT COLOR="#976633"><B>+ <?=number_format($deli_price)?>원</B></FONT></td>
		</tr>
		<?}?>
		<tr>
			<td align=right bgcolor=#f0f0f0 style="padding-right:15;font-size:17"><FONT COLOR="#976633"><B>총 결제금액</B></FONT></td>
		...
		<tr>
			<td align=right bgcolor=#f0f0f0 style="padding-right:15"><FONT COLOR="#0099CC"><B>적립금</B></FONT></td>
			<td align=right bgcolor=#ffffff style="padding-right:15"><FONT COLOR="#0099CC"><B><?=number_format($reserve)?>원</B></FONT></td>
		</tr>
		<?}?>
		</table>
		</td>
...
<?
	if($sumprice<$_data->deli_miniprice && $_data->deli_after!="Y" && $_data->deli_basefee>0) { 
		if($_data->deli_miniprice<1000000000) {
			...
			echo "<tr><td height=\"30\" align=\"right\" valign=\"top\" style=\"padding-right:5px;\"><font color=\"#FF4C00\" style=\"font-size:11px;letter-spacing:-0.5pt;\">* 모든 주문에 배송료 ".number_format($_data->deli_basefee)."원을 청구합니다.</font></td></tr>\n";
		}
