...
?>
	...
	<tr>
		...
		?>
		<tr>
			<td align=right bgcolor=#f0f0f0 style="padding-right:15"><FONT COLOR="#000000"><B>VAT 합계금액</B></FONT></td>
...
?>
		...
		<A HREF="<?=$Dir.FrontDir?>login.php?chUrl=<?=urlencode($Dir.FrontDir."order.php")?>"><IMG SRC="<?=$Dir?>images/common/basket/<?=$_data->design_basket?>/basket_skin1_btn7.gif" border="0"></a>
		<? } else { ?>
