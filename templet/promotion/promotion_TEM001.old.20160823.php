...
<!-- [D] 20160819 이벤트 퍼블리싱 작업 -->
<div id="contents">
	<div class="inner">
		<main class="event_wrap">
			<section class="event_main">
				<div class="visual_img">
					<img src="../static/img/test/@test_event_top01.jpg" alt="">
				</div>
				<ul class="my-tab-menu">
					<li class="on"><a href="javascript:void(0);" class="idx-menu">진행중인 이벤트</a></li>
					<li><a href="javascript:void(0);" class="idx-menu">종료된 이벤트</a></li>
					<li><a href="javascript:void(0);" class="idx-menu">당첨자발표</a></li>
				</ul>
				<!-- 진행중인 이벤트 -->
				<div class="idx-content on">
					<ul class="list clear">
						<li>
							<a href="#">
								<figure>
									<img src="../static/img/test/@test_event_list01.jpg" alt="이벤트 썸네일">
									<figcaption>
										<p class="subject">여름시즌 한정 이벤트</p>
										<p class="date">2016.08.05 ~ 2016.09.01</p>
									</figcaption>
								</figure>
							</a>
						</li>
						<li>
							<a href="#">
								<figure>
									<img src="../static/img/test/@test_event_list02.jpg" alt="이벤트 썸네일">
									<figcaption>
										<p class="subject">여름시즌 한정 이벤트</p>
										<p class="date">2016.08.05 ~ 2016.09.01</p>
									</figcaption>
						...
						<li>
							<a href="#">
								<figure>
									<img src="../static/img/test/@test_event_list03.jpg" alt="이벤트 썸네일">
									<figcaption>
										<p class="subject">여름시즌 한정 이벤트</p>
										<p class="date">2016.08.05 ~ 2016.09.01</p>
									</figcaption>
						...
						<li>
							<a href="#">
								<figure>
									<img src="../static/img/test/@test_event_list04.jpg" alt="이벤트 썸네일">
									<figcaption>
										<p class="subject">여름시즌 한정 이벤트</p>
										<p class="date">2016.08.05 ~ 2016.09.01</p>
									</figcaption>
						...
						<li>
							<a href="#">
								<figure>
									<img src="../static/img/test/@test_event_list05.jpg" alt="이벤트 썸네일">
									<figcaption>
										<p class="subject">여름시즌 한정 이벤트</p>
										<p class="date">2016.08.05 ~ 2016.09.01</p>
									</figcaption>
						...
						<li>
							<a href="#">
								<figure>
									<img src="../static/img/test/@test_event_list06.jpg" alt="이벤트 썸네일">
									<figcaption>
										<p class="subject">여름시즌 한정 이벤트</p>
										<p class="date">2016.08.05 ~ 2016.09.01</p>
									</figcaption>
						...
						<li>
							<a href="#">
								<figure>
									<img src="../static/img/test/@test_event_list07.jpg" alt="이벤트 썸네일">
									<figcaption>
										<p class="subject">여름시즌 한정 이벤트</p>
										<p class="date">2016.08.05 ~ 2016.09.01</p>
									</figcaption>
						...
						<li>
							<a href="#">
								<figure>
									<img src="../static/img/test/@test_event_list08.jpg" alt="이벤트 썸네일">
									<figcaption>
										<p class="subject">여름시즌 한정 이벤트</p>
										<p class="date">2016.08.05 ~ 2016.09.01</p>
									</figcaption>
				...
				<div class="idx-content">
					...
					<table class="th_top">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td class="subject"><a href="#">핫 썸머 바캉스 준비 이벤트!</a></td>
								<td>2016.06.16 - 2016.08.30</td>
								<td>2016.08.30</td>
								<td>진행중</td>
							</tr>
							<tr>
								<td>2</td>
								<td class="subject"><a href="#">7월 출석체크 lucky box 1+1 이벤트</a></td>
								<td>2016.06.16 - 2016.08.30</td>
								<td>2016.08.30</td>
								<td>종료</td>
							</tr>
