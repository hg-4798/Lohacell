...
<section class="promo-detail-comment">
    ...
    <div class="comment-write">
        <!-- <input type="text" placeholder="<?=$placeHolderMsg?>" title="댓글" id="up_comment" name="up_comment" onKeyUp="checkByte(this.form);" onClick="clearMessage(this.form);"> -->
		<textarea placeholder="<?=$placeHolderMsg?>" title="댓글" id="up_comment" name="up_comment" onKeyUp="checkByte(this.form);" onClick="clearMessage(this.form);"></textarea>
        <!--button class="btn-def btn-write" type="button">등록</button-->
        <button class="btn-def btn-write big" type="submit">등록</button>
    </div>
