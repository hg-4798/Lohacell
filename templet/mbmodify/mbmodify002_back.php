...
<tr>
	...
	<tr>
		...
		<TR>
			...
			<TD><A HREF="<?=$Dir.FrontDir?>mypage_usermodify.php"><IMG SRC="<?=$Dir?>images/common/mypersonal_skin2_menu7r.gif" BORDER="0"></A></TD>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td colspan="4" background="<?=$Dir?>images/common/mbmodify/memberjoin_p_skin_line.gif"  HEIGHT=12></td>
			</tr>
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td><INPUT type=text name="home_post1" value="<?=$home_post1?>" readOnly style="WIDTH:40px;BACKGROUND-COLOR:#F7F7F7;" class="input"> - <INPUT type=text name="home_post2" value="<?=$home_post2?>" readOnly style="WIDTH:40px;BACKGROUND-COLOR:#F7F7F7;" class="input"><a href="javascript:f_addr_search('form1','home_post','home_addr1',2);"><img src="<?=$Dir?>images/common/mbmodify/<?=$_data->design_mbmodify?>/memberjoin_skin2_btn2.gif" border="0" align="absmiddle" hspace="3"></a></td>
				</tr>
				<tr>
...
?>
	...
	<tr>
		<td align="center"><A HREF="javascript:CheckForm()"><img src="<?=$Dir?>images/common/mbmodify/<?=$_data->design_mbmodify?>/usermodify_skin2_btn1.gif" border="0"></A><A HREF="javascript:history.go(-1)"><img src="<?=$Dir?>images/common/mbmodify/<?=$_data->design_mbmodify?>/usermodify_skin2_btn2.gif" border="0" hspace="5"></A></td>
	</tr>
	<tr>
		<td height="20"></td>
	</tr>
