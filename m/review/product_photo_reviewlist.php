...
$offset = ($page-1)*$limit;
$productReview_list = $Review->productReview($productcode,'photo',$limit,$offset);
...
$paging_config = array(
    ...
    'page_current'=>$page,
    'url_type'=>'javascript',
    'url'=>'ProductDetail.photoReviewLoadPage'
);
...
_render('review/product_photo_reviewlist.html', $assign, MDir.'/template');
