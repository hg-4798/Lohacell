...
$(document).on( 'click', '#same_address', function(){
    if( $(this).prop( 'checked' ) ){
        ...
        $('#receiver_tel11 > option').each( function(){
            if( $(this).val() == "<?=$home_tel[0]?>" ) {
                $(this).prop( 'selected', true );
            }
        });

        $('#receiver_tel12').val( "<?=$home_tel[1]?>" );
        $('#receiver_tel13').val( "<?=$home_tel[2]?>" );
//        console.log( $('#sender_tel1').val() );
...
<!-- 주문 쿠폰 팝업 -->
<div id='o-coupon-layer' class='popup-layer' >
    <div class='popup-layer-dim' ></div>
    <!-- 주문 상품 쿠폰 -->
    <div id="product-coupon" class="popup-layer-inner popup-layer-alert" >
...
?>
            <ul class="goods-use-coupon" name="product_area">
                <li>
                    <figure class="goods">
                        <img src="<?=getProductImage( $productImgPath, $product['tinyimage'] )?>">
                        <figcaption><span class="brand-nm"><?=$product['productname']?></span><?=$product['productname']?></figcaption>
                    </figure>
...
?>
                            <label>
                                <input type="radio" name="product_coupon[<?=$product['basketidx']?>]" value="<?=$prcouponVal->ci_no?>"
...
?>
                            <label>
                                <input type="radio" name="product_coupon[<?=$product['basketidx']?>]" value=""
                                    data-cp-code=""
                                    data-pr-price="<?=$product_price?>"
                                    data-basketidx="<?=$product['basketidx']?>"
                                    checked
...
?>
            <div class='btn-place'>
                <a class="btn-def" href="javascript:;" id='pr-coupon-choise' >확인</a>
                <a class="btn-def" href="javascript:;" id='pr-coupon-cancel' >취소</a>
            </div>
        </div>
        <a class="btn-close" href="javascript:prd_coupon_close();" >
            <img src="<?=$Dir?>m/static/img/btn/btn_close_popup_x.png" alt="팝업닫기">
        </a>
    </div>
    <!-- 장바구니 쿠폰 -->
    <div id="basket-coupon" class="popup-layer-inner" >
        <div class="popup-layer-content">
            <p> 사용가능 할인 쿠폰 </p>
...
?>
                ...
                <!-- <li>
                    <section class="coupon-list">
                        <div>
                            <label>사용가능한 쿠폰이 없습니다.</label>
                            <label>
                                <input type="radio" name="basket_coupon" value="<?=$bcouponVal->ci_no?>"
                                    data-cp-code="<?=$bcouponVal->coupon_code?>"
                                ><?=$bcouponVal->coupon_name?>
                            </label>
                        </div>
                    <section>
                </li>  -->
            ...
            <div class='btn-place'>
                <a class="btn-def" href="javascript:;" id='bk-coupon-choise' >확인</a>
                <!-- <a class="btn-def" href="javascript:bk_coupon_close();" id='' >확인</a> -->
                <a class="btn-def" href="javascript:;" id='bk-coupon-cancel' >취소</a>
            </div>
        </div>
        <a class="btn-close" href="javascript:bk_coupon_close();"  >
            <img src="<?=$Dir?>m/static/img/btn/btn_close_popup_x.png" alt="팝업닫기">
        </a>
    </div>

    <!-- 배송비 무료 쿠폰 -->
    <div id="delivery-coupon" class="popup-layer-inner" >
        <div class="popup-layer-content">
            <p> 사용가능 쿠폰 </p>

            <ul class="goods-use-coupon" name="delivery_coupon_area">
<?php
...
?>
            ...
            <div class='btn-place'>
                <a class="btn-def" href="javascript:;" id='deli-coupon-choise' >확인</a>
                <a class="btn-def" href="javascript:;" id='deli-coupon-cancel' >취소</a>
            </div>
        </div>
        <a class="btn-close" href="javascript:deli_coupon_close();"  >
            <img src="<?=$Dir?>m/static/img/btn/btn_close_popup_x.png" alt="팝업닫기">
        </a>
    </div>
...
<main id="content">
			...
			<div class="layer-content">
				<ul class="list_addr">
					<li>
						<a href="#">
							<div class="clear">
								<p class="name">우리집 <span class="tag">기본배송지</span></p>
								<p class="tel">010-6325-7845</p>
							</div>
							<p class="addr">서울 성북구 돌곶이로 17길 4</p>
						</a>
	...
	<!-- 쿠폰 선택 레이어팝업 (2016-08-16 추가) -->
	<div class="layer-dimm-wrap layer_coupon_use">
		<div class="dimm-bg"></div>
		<div class="layer-inner">
							...
							<div class="box_mylist">
								<div class="content">
									...
									<div class="select_coupon">
										<label><input type="radio" name="product01" class="custom_radio" checked> 전체 상품 금액 할인 쿠폰</label>
										<label><input type="radio" name="product01" class="custom_radio"> 선택안함</label>
									</div>
								</div>
								<div class="discount">할인금액 <strong class="point-color">16,000원</strong></div>
							</div>
						</li>
						<li>
							<div class="box_mylist">
								<div class="content">
									...
									<div class="select_coupon">
										<label><input type="radio" name="product02" class="custom_radio" checked> 전체 상품 금액 할인 쿠폰</label>
										<label><input type="radio" name="product02" class="custom_radio"> 선택안함</label>
									</div>
								</div>
								<div class="discount">할인금액 <strong class="point-color">16,000원</strong></div>
							</div>
	...
	<div class="cart-order-wrap">
        ...
        <!-- [D] 기존 내용 hide -->
		<div class="order-pay-goods hide">
            <dl class="order-section">
                <dt><button type="button">주문하실 상품(<?=number_format(count($_odata))?>)</button></dt>
                <dd>
<?php
$sumprice = 0;
$deli_price = 0; // 선불 배송료
...
?>
                    ...
                    <div class="item-info-wrap vm">
                        <div class="inner">
                            <p class="thumb">
                                <a href="<?=$Dir?>m/productdetail.php?productcode=<?=$product['productcode']?>">
                                    <img src="<?=getProductImage( $productImgPath, $product['tinyimage'] )?>" alt="">
                                </a>
                            </p>
                            <div class="price-info">
                                <span class="brand-nm"><?=$vender_name?></span>
                                <span class="goods-nm"><?=$product['productname']?></span>
<?php
...
<?php
            ...
            foreach( $product['option'] as $optKey=>$optVal ){
                ...
                if( $optVal['option_type'] == '1' ) {
                    $tmpVal = explode( chr( 30 ), $optVal['option_code'] );
                    $optText = $tmpVal[1].' / ';
                } else {
                    $tmpVal = option_slice( $optVal['option_code'], $optVal['option_type'] );
                    foreach( $tmpVal as $opt1_val ){
                        $optText .= $opt1_val.' / ';
                    }
                }
                $tmp_opt_price += $optVal['option_price'] * $product['quantity'];
            ...
            echo ' 수량 : '.number_format( $product['quantity'] );
            if( $tmp_opt_price > 0 ) echo ' / 추가금액 : '.number_format( $tmp_opt_price );
?>
                                </span>
<?php
		} // opt1_name len if
        $pr_reserve = getReserveConversion( $product['reserve'], $product['reservetype'], ( $product['price'] * $product['quantity'] ) + $tmp_opt_price , "N" );
        $product_reserve += $pr_reserve; // 벤더별 상품 예상 적립금
        $total_reserve += $product_reserve;
        $product_price = ( $product['price']  * $product['quantity'] ) + $tmp_opt_price; //옵션가와 상품가를 합산해준다
        $vender_price += $product_price; // 벤더별 상품가격
?>
                                <span class="price">
                                    <strong><?=number_format( $product_price )?></strong>
                                </span>
                            </div>
                        </div>
                    </div><!-- //.item-info-wrap -->
...
?>
                                <div class="price">
                                    ...
                                    <strong><?=number_format( $vender_deli_price )?></strong>원
                                </div>
                            </article>
                        </section>
                        <section>
...
?>
                    ...
                    <div class="pay-price total-benefit" >
						<section>
							<h4>마일리지 적립</h4>
							<div class="price"><strong><? if($staff_order == 'N') { echo number_format( $total_reserve ); } else { echo '0'; } ?></strong>M</div>
						</section>
						<section>
							<h4>총 결제금액</h4>
							<div class="price"><strong><?=number_format($sumprice + $deli_price)?></strong>원</div>
						</section>
                    </div>
        ...
        <!-- [D] 2016. 퍼블 작업 -->
		<!-- 상품별 섹션 반복 -->
		<h3 class="pro_title">CONVERSE</h3>
		<section class="cart-list-wrap order">
            <ul class="list vender_product_list">
				...
				<li class="vender_area">
					<div class="product_area">
						<div class="box_cart">
							<figure class="mypage_goods">
								<div class="img"><a href="#"><img src="static/img/test/@orderlist_goods01.jpg" alt="주문상품 이미지"></a></div>
								<figcaption>
									<p class="brand">[나이키]</p>
									<p class="name">루나에픽 플라이니트 MEN 신발</p>
									<p class="shipping">
										<span>사이즈 : 250</span> / <span>수량 : 2</span>
									</p>
									<p class="price">
										<span class="point-color">160,000원</span>
										<span class="ap">160AP</span>
									</p>
								</figcaption>
							</figure>
						</div>
			...
			<div class="pay-price">
				<section class="benefit bd-none">
					<article>
						<h4>상품금액</h4>
						<div class="price"><strong>296,000</strong>원</div>
					</article>
					<article>
						<h4 class="title-delivery">배송비</h4>
						<div class="price">
				...
				<section>
					<h4>총 주문금액</h4>
					<div class="price total"><strong>298,500</strong>원</div>
				</section>
			</div>
        ...
        <!-- <div class="send-person">
            <dl class="order-section">
                <dt><button type="button">주문고객정보</button></dt>
                <dd>
                    <ul class="form-input">
                        <li>
                            <label for="name">이름</label>
                            <input type="text" class="w120" name="sender_name" value="<?=$userName?>" >
                        </li>
                        <li>
                            <label for="user-email">이메일</label>
                            <input type="email" class="w100-per" id="user-email" name='sender_email' value='<?=$email?>' >
                        </li>
                        <li>
                            ...
                            <div class="tel-input">
                                ...
                                <div><input type="tel" id="sender_tel2" name="sender_tel2" value="<?=$mobile[1] ?>" maxlength='4' ></div>
                                <div><input type="tel" id="sender_tel3" name="sender_tel3" value="<?=$mobile[2] ?>" maxlength='4' ></div>
                            </div>
                        </li>
                        <li class="tel-choice">
                            ...
                            <div class="tel-input">
                                ...
                                <div><input type="tel" name="home_tel2" id="home_tel2" maxlength='4' ></div>
                                <div><input type="tel" name="home_tel3" id='home_tel3' maxlength='4' ></div>
                            </div>
                        </li>
                    </ul>
                </dd>
		...
		<div class="order_table">
			...
			<table class="my-th-left">
				...
				<tbody>
					...
					<tr>
						<th>총 쿠폰할인</th>
						<td>사용된 쿠폰이 없습니다. <button type="button" class="btn_coupon_use btn-def">쿠폰사용</button></td>
					</tr>
					<tr>
						<th>총 배송비</th>
						<td><?=number_format( $deli_price )?>원</td>
					</tr>
					<tr>
						<th>총 결제금액</th>
						<td><strong class="point-color"><?=number_format($sumprice + $deli_price)?>원</strong></td>
					</tr>
				</tbody>
			</table>
		</div>
        ...
        <!-- [D] 기존 내용 hide -->
		<div class="get-person hide">
            <dl class="order-section">
                <dt><button type="button">배송지정보</button></dt>
                <dd>
                    <ul class="category-box" name="delivery-category" >
                        <li><a href="javascript:;" class="on">최근배송지</a></li>
                        <li><a href="javascript:;">배송주소록</a></li>
                        <li><a href="javascript:;">새로운주소</a></li>
                    </ul>
                    <ul class="form-input " id='addr_input' ><!-- 최근배송지 & 새로운주소에 사용 -->
                        <li>
                            <label for="name2">이름</label>
                            <input type="text" class="w120" name = 'receiver_name' id='receiver_name' >
                            <div class="same-address"><label><input type="checkbox" id='same_address' >주문고객과 동일</label></div>
                        </li>
                        <li class="address">
                            <label for="address-code">주소</label>
                            <input type="number" id="post" name='post' class="w120">
                            ...
                            <div><input type="text" name = 'raddr1' id = 'raddr1' ></div>
                            <div><input type="text" name = 'raddr2' id = 'raddr2' ></div>
                        </li>
                        <li>
                        ...
                        <li class="memo">
                            ...
                            <input type="text"  name = 'order_prmsg' id="delivery-needs" placeholder="기타 메모를 입력해주세요(한글 30자 이내)">
                        </li>
                    </ul><!-- //최근배송지 & 새로운주소에 사용 -->
                    <div class="addres-list-wrap" id='addr_list' data-memid='<?=$_ShopInfo->getMemid()?>'><!-- 배송주소록 -->
                    </div><!-- //배송주소록 -->
                </dd>
            </dl>
        </div><!-- //.get-person -->
		...
		<div class="order_table">
			<h3>
				배송지정보
				<label><input type="checkbox" class="checkbox_custom">기본 배송지 사용</label>
			...
			<table class="my-th-left form_table">
				...
				<tbody>
					...
					<tr>
						<th>배송<br> 요청사항</th>
						<td><input type="text" name = 'order_prmsg' id="delivery-needs" title="배송 요청사항"></td>
					</tr>
				</tbody>
			</table>
		</div><!-- //.order_table -->
...
?>
                            <a href="javascript:prd_coupon_pop();" id='prd-coupon-button' class="btn-function">쿠폰사용</a>
                            <!-- <a href="#" class="btn-function">쿠폰사용 완료</a> -->
<?php
        } else {
?>
                            <a href="javascript:alert('사용 가능한 쿠폰이 없습니다.');" class="btn-function">쿠폰사용</a>
                            <!-- <a href="#" class="btn-function">쿠폰사용 완료</a> -->
<?php
        }
?>
...
?>
                            <a href="javascript:bk_coupon_pop();" id='bk-coupon-button' class="btn-function">쿠폰사용</a>
                            <!-- <a href="#" class="btn-function">쿠폰사용 완료</a> -->
<?php
        } else {
?>
...
?>
                        <li>
                            <label>배송비 쿠폰</label>
                            <a href="javascript:deli_coupon_pop();" id='deli-coupon-button' class="btn-function">쿠폰사용</a>
                            <!-- <a href="#" class="btn-function">쿠폰사용 완료</a> -->
                        </li>
<?php
        }
...
?>
                        <li class="mileage">
                            ...
                            <label for="use-mileage"><? if($staff_order == 'Y') { echo '임직원 '; } ?>마일리지</label>
<?php
        if( $_data->reserve_maxprice > $sumprice ) {
?>
                             <div class="mileage-dc-att">
                                <span class="now" >구매금액이 <?=number_format( $_data->reserve_maxprice )?>원 이상이면 사용가능합니다.</span>
...
?>
                             <div class="my">
                                <span class="now"><strong id="current_mileage"><?=number_format( $user_reserve )?></strong>M</span>
                                <div class="inp-cover"><input type="number" name="usereserve" id="mileage-use" ></div>
                                <button class="btn-function" type='button' name='mileage-on' ><span>사용</span></button>
<?php
        }else{
?>
                             <div class="mileage-dc-att">
                                <span class="now" >
                                    ...
                                    (보유 마일리지 : <strong><?=number_format( $user_reserve )?></strong>M )
                                </span>
                                <input type="hidden" name="usereserve" id="mileage-use" value='0'>
<?php
        }
?>
                            ...
                            <div class="hide">※ <?=number_format( $_data->reserve_maxprice )?> 이상시 1,000 단위로 사용가능</div> <!-- 5000 -->
            ...
            <dl class="order-section">
                ...
                <dd>
                    <div class="pay-price">
                        <section>
                            <h4>총 주문금액</h4>
                            <div class="price"><strong><?=number_format($sumprice)?></strong>원</div>
                        </section>
                        <section>
                            <h4>배송비(선불)</h4>
                            <div class="price"><strong class='CLS_before_deli'><?=number_format($deli_price)?></strong>원</div>
                        </section>
                        <section>
                            <h4>배송비(착불)</h4>
                            <div class="price"><strong class='CLS_after_deli'><?=number_format($deli_price2)?></strong>원</div>
                        </section>
                        <section>
                            <h4>상품쿠폰</h4>
                            <div class="price"><strong class='CLS_prCoupon'>(-) 0</strong>원</div>
                        </section>
                        <section>
                            <h4>할인쿠폰</h4>
                            <div class="price"><strong class='CLS_bCoupon'>(-) 0</strong>원</div>
                        </section>
                        <section>
                            <h4><? if($staff_order == 'Y') { echo '임직원 '; } ?>마일리지 할인</h4>
                            <div class="price"><strong class='CLS_saleMil' >(-) 0</strong>원</div>
                        </section>
                    </div>
					<div class="pay-price total-benefit">
						<section>
						...
						<section class="total">
							<h4>총 결제금액</h4>
							<div class="price"><strong id="price_sum"><?=number_format($sumprice+$deli_price)?></strong>원</div>
						</section>
					</div>
                </dd>
            </dl>
		...
		<div class="select_payment">
			...
			<div>
				<ul class="list_payment clear" name='payment-category' >
					<li><a href="javascript:payment_select('Y');" class='on'><img src="static/img/common/logo_payco.gif" alt="PAYCO"></a></li>
					<li><a href="javascript:payment_select('C');">신용카드(일반)</a></li>
					<li><a href="javascript:payment_select('V');">실시간 계좌이체</a></li>
					<li><a href="javascript:payment_select('O');">가상계좌</a></li>
					<li><a href="javascript:payment_select('B');">무통장 입금</a></li>
					<!-- <li><a href="javascript:payment_select('Q');">에스크로(가상계좌)</a></li> -->
...
<script>
    function payment_select( paymethod ){
        if ( paymethod == "" ) {
            ...
            $('.category-box li a').removeClass("on");  // 결제 수단 선택을 초기화
