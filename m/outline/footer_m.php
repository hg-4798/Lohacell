...
<div class="quick_btn_wrap">
	<a href="javascript:;" class="top_btn"><img src="/jayjun/m/static/img/btn/btn_top.gif" alt="페이지 상단 바로가기"></a>
	<a href="javascript:history.back();" class="prev_btn"><img src="/jayjun/m/static/img/btn/btn_prev.gif" alt="이전 페이지로 가기"></a>
</div>
...
<!-- 푸터 -->
		<footer id="footer">
			<div class="sns">
				...
				<!-- 
				<a onclick="new_open('https://www.facebook.com/mall.shinwon.9');" target="_blank"><img src="/jayjun/m/static/img/icon/icon_ft_facebook.png" alt="facebook"></a>
				 -->
				<a onclick="new_open('https://www.instagram.com/shinwonmall/');" target="_blank"><img src="/jayjun/m/static/img/icon/icon_ft_instagram.png" alt="instagram"></a>
				<a onclick="new_open('https://www.youtube.com/channel/UCITkKbSvb3hjm8rTeLW1Jcw/feed');" target="_blank"><img src="/jayjun/m/static/img/icon/icon_ft_youtube.png" alt="youtube"></a>
			</div>
			...
			<div class="footer-info">
				<div class="ft_menu">
					...
					<a href="<?=$Dir.MDir?>customer_grade.php">멤버십 안내</a>
