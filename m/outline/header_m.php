...
if(strpos($_SERVER['HTTP_USER_AGENT'],"IN_APP")>0) {
	set_session("ACCESS","app");
} else if((strpos($_SERVER['HTTP_USER_AGENT'], "iPhone;") || strpos($_SERVER['HTTP_USER_AGENT'], "iPad;")) && strpos($_SERVER['HTTP_USER_AGENT'], "Safari/") === false) {
	set_session("ACCESS", "app");
}
	//app 체크하여 세션을 저장한다.
	if ($_REQUEST['act'] == 'app') {
...
<!-- NSM Site Analyst END -->
	...
	<script type="text/javascript" src="/jayjun/m/static/js/jquery-1.12.0.min.js"></script>
	<!-- <script src="http://code.jquery.com/jquery-1.11.1.min.js"></script> -->
<!-- <script src="http://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js"></script> -->
	<script type="text/javascript" src="/jayjun/m/static/js/jquery.bxslider.min.js"></script>
	<script type="text/javascript" src="/jayjun/m/static/js/Carousel.min.js"></script>
	<script type="text/javascript" src="/jayjun/m/static/js/nouislider.min.js"></script>
	<script type="text/javascript" src="/jayjun/m/static/js/wNumb.min.js"></script>
	<script type="text/javascript" src="/jayjun/m/static/js/masonry.pkgd.min.js"></script>
	<script type="text/javascript" src="./static/js/ui_jayjun.min.js?v=13"></script>
	<script type="text/javascript" src="/jayjun/m/static/js/buildV63.js"></script>
	...
	<script language="JavaScript">
		...
		$( document ).ready(function() {
			...
			if(basename.match('index')){
				if(get_session != 'app' && mobile_os == 'ios'){
					str += '<div class="topbanner">';
					str += '	<a href="https://appsto.re/kr/1XY0jb.i">';
					str += '		<span class="logo_sm"><img src="/jayjun/m/static/img/common/logo_sm.gif" alt="SHINWON MALL"></span>';
					str += '		<span class="ment">APP으로 포인트 받고 쇼핑하기</span>';
					str += '	</a>';
					str += '	<button type="button" class="btn_close" onclick="pop_close_off()"><img src="/jayjun/m/static/img/btn/btn_layer_close.png" alt="닫기"></button>';
					str += '</div>';
				...
				if(pop_close != 'Y' && get_session != 'app' && mobile_os == 'ios'){
					str += '<div class="topbanner">';
					str += '	<a href="https://appsto.re/kr/1XY0jb.i">';
					str += '		<span class="logo_sm"><img src="/jayjun/m/static/img/common/logo_sm.gif" alt="SHINWON MALL"></span>';
					str += '		<span class="ment">APP으로 포인트 받고 쇼핑하기</span>';
...
<div id='pop_close_off'></div>
	...
	<div class="header">
		<h1><a href="/m"><img src="/jayjun/m/static/img/common/logo.png" alt="SW eshop"></a></h1>
		<!-- LNB -->
		<div class="lnb-wrap">
			<button class="btn-lnb-open" type="button"><img src="/jayjun/m/static/img/btn/btn_lnb_open.png" alt="카테고리 메뉴 보기"></button>
			<div class="lnb-layer">
				<div class="lnb-layer-dim"></div>
				<div class="lnb-layer-inner">
					<div class="lnb-top">
						<a href="/m" class="btn-lnb-home">HOME<!-- <img src="/jayjun/m/static/img/btn/btn_lnb_home.png" alt="HOME"> --></a>
						<!-- <span class="btn-menu"><a href="outlet.php">OUTLET</a></span> -->
						<button type="button" class="btn-lnb-close"><img src="/jayjun/m/static/img/btn/btn_lnb_close.png" alt="카테고리 메뉴 숨기기"></button>
					</div><!-- //.lnb-top -->
						...
						<div class="lnb-tab" data-ui="TabMenu">
							...
							<div class="tab-content active" data-content="content">
								...
								<ul class="main_category_button">
									...
									<li><a href="http://shinwonmall.com/magazine">月刊(월간) 신원몰</a></li>
								</ul>
								<!-- //컨텐츠 메뉴 -->
							</div>
							<!-- //신상품 카테고리 -->
		...
		<a href="#" id="btn_search"><img src="/jayjun/m/static/img/btn/btn_search.png" alt="검색"></a>

		<div class="pop_search">
			<button type="button" class="close_search"><img src="/jayjun/m/static/img/btn/btn_layer_close.png" alt="닫기"></button>
			...
			<div class="container">
				<div class="searchbox">
					...
					<button type="submit"><img src="/jayjun/m/static/img/btn/btn_search.png" alt="검색"></button>
				</div>
		...
		<div class="rnb-wrap">
			<button class="btn-rnb-open" type="button"><img src="/jayjun/m/static/img/btn/btn_rnb_open.png" alt="마이페이지 메뉴 보기"></button>
			<div class="rnb-layer">
				...
				<div class="rnb-layer-inner">
					<div class="lnb-top">
						...
						<a href="<?$Dir.MDir?>logout.php" class="btn-lnb-login">
							<img src="/jayjun/m/static/img/btn/btn_lnb_logout.png" alt="logout">
							<span>로그아웃</span>
						</a>
						<!-- //로그인 후 -->
						...
						<a href="login.php?chUrl=<?if (strstr($_SERVER[REQUEST_URI], 'login.php')) { echo trim(urlencode($_REQUEST["chUrl"])); } else { echo trim(urlencode($_SERVER[REQUEST_URI])); }?>" class="btn-lnb-login">
							<img src="/jayjun/m/static/img/btn/btn_lnb_login.png" alt="login">
							<span>로그인</span>
						</a>
						<!-- //로그인 전 -->
						<?php }?>

						<button type="button" class="btn-lnb-close"><img src="/jayjun/m/static/img/btn/btn_lnb_close.png" alt="마이페이지 메뉴 숨기기"></button>
					</div><!-- //.lnb-top -->
					...
					<div class="content">
							...
							<ul class="clear">
								<li>
									<a href="mypage_goods.php">
										<span class="icon"><img src="/jayjun/m/static/img/icon/icon_like.png" alt="좋아요"></span>
						...
						<div class="mycategory">
							...
							<ul>
								...
								<li><a href="<?=$Dir.MDir?>mypage_personal.php">1:1 문의</a></li>
