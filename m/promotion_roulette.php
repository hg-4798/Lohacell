...
<?if($pidx == '266'){?>
	<section class="photo_type_view">
		...
		<div class="rlt_event" style="background-image:url(/sinwon/web/static/img/common/roulette_bg_m_266.png);"><!-- [D] 룰렛배경이미지 -->
			<div class="wrap_wheel">
				<div class="spin_wheel">
					<span class="pointer"><img src="/sinwon/web/static/img/common/roulette_pointer_266.png" alt="포인터"></span><!-- [D] 룰렛포인터이미지 -->
					...
					<div class="spin_button" style="background-image:url(/sinwon/web/static/img/common/roulette_btn_266.png);"><!-- [D] 룰렛버튼이미지 -->
			...
			<div class="notice clear">
				...
				<ul>				
					...
					<li>발급된 쿠폰/포인트는 발급일인 22일 단 하루만 </li>
					<li>사용이 가능하고 기간이 지나면 사용 및 재발급 불가하오니 참고 부탁 드립니다.</li>
