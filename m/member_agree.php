...
<script>
    function Check() {
        ...
        var agree_check01 = $('#agree_check01').is(":checked");
        var agree_check02 = $('#agree_check02').is(":checked");
        if(agree_check01 && agree_check02) {
...
<main id="content" class="subpage with_bg">
	...
	<section class="joinpage join_form">
		...
		<div class="agree_form">
			<h3 class="tit">iKNOW iONE 서비스 이용약관(필수)</h3>
			<!--  
			<textarea><?=$agreement?></textarea>
			-->
			<div style="overflow:scroll; height:130px; padding:10px; background-color:white;"><?=htmlspecialchars_decode($agreement)?></div>
			<label for="agree_check01"><input id="agree_check01" name="agree_check01" type="checkbox" class="chk_agree check_def" onclick="Check()"> <span>약관에 동의합니다.</span></label>
		</div><!-- //.agree_form -->

		<div class="agree_form mt-25">
			<h3 class="tit">개인정보취급방침(필수)</h3>
			<div style="overflow:scroll; height:130px; padding:10px; background-color:white;"><?=htmlspecialchars_decode($privacy)?></div>
			<label for="agree_check02"><input id="agree_check02" name="agree_check02" type="checkbox" class="chk_agree check_def" onclick="Check()"> <span>개인정보취급방침에 동의합니다.</span></label>
		</div><!-- //.agree_form -->
