				...
				<dl>
					...
					<dd>
						<div class="input_tel">
							...
							<input type="tel" maxlength="4" id="phone_num2" onkeyup="strnumkeyup(this);">
							<span class="dash"></span>
							<input type="tel" maxlength="4" id="phone_num3" onkeyup="strnumkeyup(this);">
						</div>
					</dd>
				</dl>
				<dl>
					...
					if( count($list) > 0 ) {
						...
						foreach( $list as $key=>$val ){
							...
							if($type_menu == 'waite' || $type_menu ==''){
								...
								$temp_answer .= "<p class=\"writer\"><span>관리자</span><span class=\"a_date\">".date("Y.m.d", strtotime( $val['re_date']) )."</span></p>";
								$temp_answer .= "<p class=\"txt\">".$val['re_subject']."</p>";
								$temp_answer .= "<p class=\"txt\">".nl2br($val['re_content'])."</p>";
								$temp_answer .= "</div>";
							}
				...
				?>
						<li>
							...
							<div class="qna_con accordion_con">
								<div class="question">
									<p class="txt"><?=nl2br($val['content'])?> </p><br>
                                    <?
                                    if($val['up_filename'] != ''){
                                        ?>
					...
					<?} ?>
			<?}else{ ?>
					<li class="history_none">내용이 없습니다.</li>
			<?} ?>
					</ul>
				</div><!-- //.inquiry_list -->
