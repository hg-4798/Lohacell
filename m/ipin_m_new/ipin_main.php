...
session_start();
	...
	*********************************************************************************************************************************************/
	...
	//$sReturnURL				= "http://..../ipin_process.php";			// 하단내용 참조
	$sReturnURL					= "";			// 하단내용 참조
	...
	$sReturnURL = $Protocol.$_SERVER['HTTP_HOST'].$Port.$loc."ipin_process.php?form_data={$form_data}";
...
<form name="form_ipin" method="post">
    ...
    <input type="hidden" name="param_r1" value="<?=$sns_type?>">
