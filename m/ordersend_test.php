...
if($beforehand_reserve == 'Y'){//즉시적립기능
	//$beforehand_reservePrice;
	$sql = "INSERT INTO tblorderproducttemp (ordercode, tempkey, productcode, productname, quantity, price, reserve, date) VALUES ('{$ordercode}','{$oldtempkey}','99999999999X','즉시 적립 할인','1','-{$beforehand_reservePrice}','0','".date("Ymd")."')";
	pmysql_query($sql,get_db_conn());
	backup_save_sql($sql);
