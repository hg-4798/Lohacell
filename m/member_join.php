	...
	<section class="joinpage join_form">
		...
		<div class="board_type_write">
			...
			<dl>
				...
				<dd>
					<div class="input_addr">
                        ...
                        ?>
						<input type="text" class="w100-per" id="user-id" name="id" tabindex="2" title="아이디 입력자리"  placeholder="아이디 입력" onChange="javascript:$('input[name=id_checked]').val('0');" value="<?=$re_id;?>">
						<div class="btn_addr"><a href="javascript:;" class="btn-basic h-input" onclick="ValidFormId('1','');return false;">중복확인</a></div>
					</div>
				</dd>
			</dl>
			<dl <?= ($sns_type == '') ? "" : "class='hide'"; ?>>
				<dt><span class="required">비밀번호</span></dt>
				<dd>
					<input type="password" class="w100-per" id="user-pwd1" name="passwd1" title="비밀번호 입력자리" tabindex="3" placeholder="영문 대소문자+숫자+특수문자 조합, 공백 없이 8자 ~ 20자리 이내로 입력">
            ...
            <dl>
				<dt>관심카테고리</dt>
				<dd class="body_info">
                    <label class="radio ml-10" for="skintype1">
                        <input type="radio" class="radio_def" name="skintype" id="skintype1" value="1">
                        <span>FACE</span>
                    </label>
                    <label class="radio ml-10" for="skintype2">
                        <input type="radio" class="radio_def" name="skintype" id="skintype2" value="2">
                        <span>LIP</span>
                    </label>
                    <label class="radio ml-10" for="skintype3">
                        <input type="radio" class="radio_def" name="skintype" id="skintype3" value="3">
                        <span>EYE</span>
                    </label>
                    <label class="radio ml-10" for="skintype4">
                        <input type="radio" class="radio_def" name="skintype" id="skintype4" value="4">
                        <span>CHEEK</span>
                    </label>
                    <label class="radio ml-10" for="skintype5">
                        <input type="radio" class="radio_def" name="skintype" id="skintype5" value="5">
                        <span>SKINCARE</span>
                    </label>
                    <!--
                    <label class="radio ml-10" for="skintype6">
                        <input type="radio" class="radio_def" name="skintype" id="skintype6" value="6">
                        <span>민감성(과민감성)</span>
                    </label>
                    <label class="radio ml-10" for="skintype7">
                        <input type="radio" class="radio_def" name="skintype" id="skintype7" value="7">
                        <span>아토피</span>
                    </label>
                    -->
                    <label class="radio ml-10" for="skintype0">
                        <input type="radio" class="radio_def" name="skintype" id="skintype0" value="0" checked="">
                        <span>없음</span>
                    </label>
			...
			<dl>
				<dt>마케팅 활동 동의</dt>
				<dd>
                    iKNOW iONE 제공하는 다양한 이벤트 및 혜택 안내에 대한 수신동의 여부를 확인해주세요. <br>수신 체크 시 고객님을 위한 다양하고 유용한 정보를 제공합니다.
