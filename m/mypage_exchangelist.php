...
$order_product = $Order->getOrderProductList($order_num,"cs_type='0' AND order_status='5'"); //주문상품, 반품 가능상태인경우에만 진행
//pre($order_product);
...
_render('mypage/exchange_list.html', $assign, DIR_M.'/template');
