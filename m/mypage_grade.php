	...
	<section class="my_membership sub_bdtop">
		...
		<div class="list_bnf">
			...
			<ul>
				...
				<li>
					...
					<div class="content">
						<p class="tit point-color">통합 포인트 적립<br><span class="sm">(상품 할인율별 최대 5%)</span></p>
				...
				<li>
					...
					<div class="content">
						...
						<p class="txt">오프라인 회원, 통합 멤버십 회원 전환 시<br><strong>통합 멤버십 웰컴 포인트</strong></p>
					</div>
				</li>
			</ul>
		</div><!-- //.list_bnf -->
		...
		<div class="membership_bnf hide mt-30">
			...
			<table class="th-top mt-10">
				...
				<thead>
					<tr>
						<th colspan="2">상품 할인율에 따른 적립률(TAG가 기준)</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td>
							<strong>상품 할인율 0~19%</strong><br>
							기존 2% 적립 / ‘17년 변경 5% 적립
						</td>
					</tr>
					<tr>
						<td>
							<strong>상품 할인율 20~49%</strong><br>
							기존 2% 적립 / ‘17년 변경 3% 적립
						</td>
					</tr>
					<tr>
						<td class="bdb2">
							<strong>상품 할인율 50% 이상</strong><br>
							기존 2% 적립 / ‘17년 변경 1% 적립
						</td>
					</tr>
					<tr>
		...
		<div class="integrated_bnf mt-25">
			...
			<table class="th-left mt-10">
				...
				<tbody>
					...
					<tr>
						<th class="bdb2">통합 멤버십 <br>웰컴 포인트</th>
						<td class="bdb2">
							<ul class="list">
