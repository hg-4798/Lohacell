        ...
        (
            ...
            from (
                    SELECT  name, id, min(email) as email, min(news_yn) as news_yn, min(bf_group) as bf_group, sum(act) as act,
                            ...
                            count(id) OC,
							(CASE 
								WHEN sum(act) >= 500000 THEN '0007'
								WHEN sum(act) >= 300000 THEN '0000'
								WHEN sum(act) >= 200000 THEN '0006'
								WHEN sum(act) >= 100000 THEN '0005'
                             	WHEN sum(act) < 100000 and sum(act) > 0 THEN '0003'
