...
function formatMaskByPostion(str, chr, startPosition) {
 str = str.trim(str);

 var temp = "";
 var endPosition = str.length;
	...
	this.getReviewList = function (prodcode,selectyp, currpage,roundpage){
		...
		if(cmtArr){
			...
			for(var i = 0 ; i < cmtArr.length ; i++){
				...
				var rname = formatMaskByPostion(cmtArr[i].name,"*",1);
				if(this.gubun=='M'){
					rows += '<li>';
					rows += '	<div class="title_area" onclick="review.openRevList('+i+');">';
					rows += '		<div class="info">';
					rows += '			<span class="rating"><img src="/jayjun/m/static/img/icon/rating'+avg_point.toFixed(0)+'.png" alt="5점 만점 중 4점"></span>';
					rows += '			<span class="id">'+rname+'</span>';
					...
					if(cmtArr[i].upfile!=''){
					rows += '			<img src="/jayjun/m/static/img/icon/icon_camera.png" alt="사진첨부">';
					}
					rows += '		</a></p>';
					rows += '	</div>';
					...
					rows += 	'<td class="score-icon"><img src="/jayjun/web/static/img/icon/rating'+avg_point.toFixed(0)+'.png" alt="5점 만점 중 '+avg_point+'점"></td>';
		...
		$('#avg_point').html('<img src="/jayjun/web/static/img/icon/rating'+avg_pointB+'.png" alt="5점 만점 중 점">');
	...
	<div class="layer-inner">
		...
		<div class="layer-content">
			...
			<div class="review-point mt-10">
				<div class="icon" id="avg_point">
					<!-- <img src="/jayjun/web/static/img/icon/rating1.png" alt="5점 만점 중 1점">
					<img src="/jayjun/web/static/img/icon/rating2.png" alt="5점 만점 중 2점">
					<img src="/jayjun/web/static/img/icon/rating3.png" alt="5점 만점 중 3점">
					<img src="/jayjun/web/static/img/icon/rating4.png" alt="5점 만점 중 4점"> -->
					<img src="/jayjun/web/static/img/icon/rating5.png" alt="5점 만점 중 5점">
				</div>
