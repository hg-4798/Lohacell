...
if ($cut_url == 'mypage_orderlist_view' || $cut_url == 'mypage_cancellist' || $cut_url == 'mypage_refundlist' || $cut_url == 'mypage_exchangelist') $checked["mypage_orderlist"] = "class='active'";
...
<div class="my-lnb">
	...
	<dl>
		<dt>주문내역조회</dt>
		<dd><a href="<?=$Dir.FrontDir?>basket.php" <?=$checked["basket"]?>>장바구니</a></dd>
		<dd><a href="<?=$Dir.FrontDir?>mypage_orderlist.php" <?=$checked["mypage_orderlist"]?>>주문배송조회</a></dd>
		<dd><a href="<?=$Dir.FrontDir?>mypage_cs.php" <?=$checked["mypage_cs"]?>>취소/교환/반품 현황</a></dd>
	</dl>

	<dl>
		<dt>혜택정보</dt>
		<dd><a href="<?=$Dir.FrontDir?>benefit.php" <?=$checked["benefit"]?>>멤버십 등급/혜택안내</a></dd>
		<dd><a href="<?=$Dir.FrontDir?>mypage_act_point.php" <?=$checked["mypage_act_point"]?>>포인트/ 마일리지</a></dd>
	...
	<dl>
		...
		<dd><a href="<?=$Dir.FrontDir?>mypage_sns.php" <?=$checked["mypage_sns"]?>">SNS 연동관리</a></dd>
