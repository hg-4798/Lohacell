        ...
        <article class="promotion-wrap">
            ...
            <div class="promotion-list-wrap ta-c mt-25" data-ui="TabMenu">
                ...
                <div class="tabs" id="menu_event" style="display: none;">
                    <button data-content="menu" class="active" onclick="DivControl(2,1);"><span>진행중 이벤트</span></button>
                    <button data-content="menu" onclick="DivControl(2,2);"><span>종료된 이벤트</span></button>
