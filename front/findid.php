...
<script>
    ...
    $(document).ready(function(){
        $(".tabs > button").click(function(){
            ...
            if(idx =='id'){
                $('#id_search_div').css('display','block');
                $('#pw_search_div').css('display','none');
            }else{
                $('#pw_search_div').css('display','block');
                $('#id_search_div').css('display','none');
            }

            $('#findpw_result_div').css('display','none');
            $('#findid_result_div').css('display','none');
        })
    });
	...
	<div class="member-page">
		...
		<article class="memberLogin-wrap certification" data-ui="TabMenu">
			...
			<div class="tabs two mt-60">
				<button type="button" data-content="menu" class="active" data-idx="id"><span>아이디 찾기</span></button>
				<button type="button" data-content="menu" data-idx="pw"><span>비밀번호 찾기</span></button>
			</div>
			...
			<div class="frm-box mt-50" id="findpw_result_div" style="display: none;">
				...
				<fieldset>
                    ...
                    <p class="ment">회원님의 아이디는 <strong class="point-color find_pw_result"></strong> 입니다.</p>
