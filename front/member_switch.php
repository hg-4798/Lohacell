			...
			<div class="frm-box mt-50 ">
				...
				<div class="member-switch">
					...
					<ul class="brand clear mt-20">
						<li><span><img src="../jayjun/web/static/img/common/brand_logo_bb.png" alt="BESTI BELLI"></span></li>
						<li><span><img src="../jayjun/web/static/img/common/brand_logo_viki2.png" alt="VIKI"></span></li>
						<li><span><img src="../jayjun/web/static/img/common/brand_logo_si.png" alt="SI"></span></li>
						<li><span><img src="../jayjun/web/static/img/common/brand_logo_isabey.png" alt="ISABEY"></span></li>
						<li><span><img src="../jayjun/web/static/img/common/brand_logo_sieg.png" alt="SIEG"></span></li>
						<li><span><img src="../jayjun/web/static/img/common/brand_logo_siegf.png" alt="SIEG FAHRENHEIT"></span></li>
						<li><span><img src="../jayjun/web/static/img/common/brand_logo_vda.png" alt="VanHart di Albazar"></span></li>
					</ul>
					<h4 class="mt-40 fz-15 fw-bold txt-toneA">신원 통합회원 전환시 받을 수 있는 혜택</h4>
					<ul class="benefit mt-20 clear">
						<li><i class="icon-point"></i>5,000 E포인트</li>
