            ...
            <article class="memberJoin-wrap">
                ...
                <section class="inner-align join-agreement">
                    <header class="sub-title">
                        <h3>iKNOW iONE 서비스 약관동의</h3>
                        <div class="checkbox" style="position: absolute; right: 0; bottom:10px">
                    ...
                    <div class="wrap">
                        ...
                        <div class="terms-box"><?=htmlspecialchars_decode($agreement)?></div>
                        <div class="checkbox mt-15">
                            <input id="agree_check01" name="agree_check01" type="checkbox" class="chk_agree checkbox-def" value="1" onclick="Check()"><label for="agree_check01">약관에 동의합니다.</label>
                        </div>
                    </div>
                    <div class="wrap">
                        <h4 class="title">개인정보취급방침(필수)</h4>
                        <div class="terms-box"><?=htmlspecialchars_decode($privacy)?></div>
                        <div class="checkbox mt-15">
                            <input id="agree_check02" name="agree_check02" type="checkbox" class="chk_agree checkbox-def" value="1" onclick="Check()"><label for="agree_check02">개인정보취급방침에 동의합니다.</label>
                        </div>
                    </div>
