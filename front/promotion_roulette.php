...
<?if($pidx == '266'){?>
				<div class="roulette-wrap" style="background-image:url(/jayjun/web/static/img/common/roulette_bg_266.jpg);"><!-- [D] 룰렛배경이미지 -->
					<!--<h3><span><strong><?=$roulette[0]->title?></span></h3>-->
					<div class="wrap-wheel">
						<div class="spin-wheel">
							<span class="pointer"><img src="/jayjun/web/static/img/common/roulette_pointer_266.png" alt="포인터"></span><!-- [D] 룰렛포인터이미지 -->
							...
							<div class="spin-button" style="background-image:url(/jayjun/web/static/img/common/roulette_btn_266.png);"><!-- [D] 룰렛버튼이미지 -->
					...
					<div class="notice1 clear">
						<p class="tit">꼭! 알아두세요.</p>
						<ul>				
							<li>이벤트 기간: 2018.05.22(화), 단 하루.</li>
							<li>신원몰 회원분들만 참여가 가능합니다.</li>
							<li>발급된 쿠폰/포인트는 발급일인 22일 단 하루만 사용이 가능하고</li>
							<li>기간이 지나면 사용 및 재발급 불가하오니 참고 부탁 드립니다.</li>
							<li>일부 상품은 쿠폰 사용에 제한이 있을 수 있습니다.</li>
							<li>주문취소 시 쿠폰 재발급 불가합니다.</li>
							<li>1개의 아이디당 1번만 응모가 가능합니다.</li>
							<li>발급된 쿠폰 및 포인트는 신원몰에서 구매시 사용이 가능하며</li>
							<li>마이페이지에서 확인 가능합니다.</li>
						</ul>
					</div>
				</div>
<?}else{?>
				<div class="roulette-wrap" style="background-image:url(/jayjun/web/static/img/common/roulette_bg.jpg);"><!-- [D] 룰렛배경이미지 -->
					<!--<h3><span><strong><?=$roulette[0]->title?></span></h3>-->
					<div class="wrap-wheel">
						<div class="spin-wheel">
							<span class="pointer"><img src="/jayjun/web/static/img/common/roulette_pointer.png" alt="포인터"></span><!-- [D] 룰렛포인터이미지 -->
							<canvas id="canvas" class="roulette" width="700" height="700">
								<p class="ta-c">Sorry, your browser doesn't support canvas. Please try another.</p>
							</canvas>
							<div class="spin-button" style="background-image:url(/jayjun/web/static/img/common/roulette_btn.jpg);"><!-- [D] 룰렛버튼이미지 -->
								<a href="javascript:;" class="spin-btn1 clickable" onclick="startRoulette()">START 클릭!</a>
								<a href="javascript:;" class="spin-btn2" onclick="alert('이미 응모하셨습니다.');">START 클릭!</a>
							</div>
						</div>
					...
					<div class="notice clear">
						...
						<ul>				
							...
							<li>발급된 쿠폰 및 포인트는 신원몰에서 구매시 사용이 가능합니다. (일부 상품 제외)</li>
...
<script type="text/javascript" src="/jayjun/web/static/js/TweenMax.min.js"></script>
<script type="text/javascript" src="/jayjun/web/static/js/Winwheel.js"></script>
<script type="text/javascript">
