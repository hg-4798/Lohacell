	...
	<div class="promotion-page">
		...
		<article class="promotion-wrap">
			...
			<div class="attendance-wrap">
				<div class="ment">
					<img src="/jayjun/web/static/img/common/attendance.png" alt="달력 이미지">
					<h3>매일 출석도장 찍고, 포인트도 챙겨가세요!</h3>
					<p>출석체크 포인트 <strong class="point-color">100P</strong> | 개근상 <strong class="point-color">2,000P</strong></p>
				</div>
				<div class="month-box">
					<div class="month-checked">이번달 출석 횟수: <strong class="point-color"><span class="fz-22" id="laststamp"></span>일</strong> / <span id="lastmonth"></span>일 <img src="/jayjun/web/static/img/icon/icon_attendance_full.png" alt="개근"></div>
					<div class="month">
