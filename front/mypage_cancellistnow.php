...
$cancel_type =$_GET["cancel_type"]?$_GET["cancel_type"]:"request";

$viewtab[$cancel_type] = "on";
...
function CheckForm() {
	...
	document.form2.cancel_type.value='request';
...
include ($Dir.TempletDir."cancellist/cancellist{$_data->design_orderlist}_now.php");
?>
