...
$openguide["301"]["area"] = "전면 5m, 20평이상";
$openguide["301"]["margin"] = "33%";
$openguide["301"]["deposit"] = "현금 2천만원 / 부동산 담보 5천만원 (월2회 결제) or <br/>현금 2천만원 / 부동산 담보 1억원(월 1회 결제)";
$openguide["301"]["payment"] = "2회결제";
$openguide["301"]["interior"] = "3.3㎡ 당 2백만원";
$openguide["301"]["person"] = '<span class="o_txt o_txt_t_m"><span>이규원 팀장</span><a href="./brand_qna.php?bridx='.$bridx.'" class="goQna">문의하기</a><br>
							<span class="o_txt">(H.P 010-6396-0485 / TEL. 02-3274-5937 / E-mail. zenmaster@sw.co.kr)</span>';
...
$openguide["303"]["person"] = '<span class="o_txt o_txt_t_m"><span>조용득 차장</span><a href="./brand_qna.php?bridx='.$bridx.'" class="goQna">문의하기</a><br>
							<span class="o_txt">(TEL. 02-3274-6016 / E-mail. ydcho@sw.co.kr)</span>';
...
<script type="text/javascript" src="./fromsw/js/jquery.change-meta-tag.js"></script>
</BODY>
</HTML>