...
class Pagination
{
	...
	private function setPaging() {
		...
		$this->page['next']=($this->total_page == $this->page_current)?$block_end:$this->page_current+1;
		$this->page['prev'] = ($this->page_current==$this->page['first'])?$block_start:$this->page_current-1;
