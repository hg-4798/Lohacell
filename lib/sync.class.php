	...
	class Sync{
		...
		function Sync(){
			...
			$arrAuthKeys = array(
                ...
                "182.162.154.120" => "2991654f18bd69be4c091a9641ea75236ca185b6690a47b65094ae24b16e4ae0", // hott 실서버 1
                "182.162.154.121" => "2991654f18bd69be4c091a9641ea75236ca185b6690a47b65094ae24b16e4ae0" // hott 실서버 2
			);
			...
			if(!$_SERVER['SERVER_ADDR']){
                ...
                else $_SERVER['SERVER_ADDR']="182.162.154.107";
			}
                ...
                */
				...
				$opSql = "
					SELECT
						...
						reserve, gps_x, gps_y, staff_price, cooper_price
					FROM
						tblorderproduct
					WHERE
						ordercode = '".$arrayData[ordercode]."'
...
// 퀵배송 가능 매장 검색 2018-
		function searchStorePossible($arrayData){
			$orderArray=Array(
				'auth_key'=>$this->authKey, 
				'_method'=>'put',
				'brand_code'=>$arrayData['brand_code'],
				'dong'=>$arrayData['dong']
			);
			...
			if($this->flagSuccess == "fail"){
				...
				$rtn=$this->jsonDecodeData->result;
			}
