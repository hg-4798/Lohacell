...
<tr>
	...
	<tr>
		...
		<tr id=shop1 style='display:none'>
			<td valign=top style=background-repeat:no-repeat;padding-top:10;padding-left:20 background=images/l_menu01.gif>
			<table border=0 cellspacing=0 cellpadding=0>
<?php
			noselectmenu('업체정보 관리','vender_info.php',$idx[0][0],0);
			noselectmenu('배송관련 기능설정','delivery_info.php',$idx[0][1],1);
			//noselectmenu('배송/교환/환불정보 노출','product_deliinfo.php',$idx[0][2],2);
?>
			</table>
			</td>
		</tr>
...
<?php
			...
			noselectmenu('상품 사용후기 관리','order_review.php',$idx[3][2],2);
?>
			</table>
			</td>
		</tr>
