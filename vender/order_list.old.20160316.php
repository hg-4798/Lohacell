...
function OrderCheckStepChange() {
	...
	//alert(document.checkstepform.ordercodes.value);
	//return;
...
<?
				...
				while($row=pmysql_fetch_object($result)) {
					...
					while($row2=pmysql_fetch_object($result2)) {
						...
						echo "	<td bgcolor=#E7E7E7></td>\n";
						echo "	<td align=right style=\"padding:3\">".number_format((($row2->price+$row2->option_price)*$row2->option_quantity)+$row2->deli_price-$row2->coupon_price-$row2->use_point)."&nbsp;</td>\n";
						echo "	<td bgcolor=#E7E7E7></td>\n";
