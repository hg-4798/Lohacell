                    ...
                    foreach( $opt_id as $optKey=>$optVal ){
                        ...
                        if( $opt_num[$optKey] != '' ){
                            ...
                            */
                            ...
                            $optInsertSql.= "( option_code, productcode, option_price, option_quantity, option_use, option_tf ) ";
                            $optInsertSql.= "VALUES ( '".$optVal."', '".$prcode."', '".$opt_price[$optKey]."', '".$opt_stock_qty[$optKey]."', '".$opt_use[$optKey]."', 'T' ) ";
                ...
                if( count( $spl_option_code ) > 0 && $opt_type == '1' ){
                    foreach( $spl_option_code as $splKey=>$splVal ) {
                        ...
                        if( $spl_num[$splKey] != '' ) {
                            ...
                            $spl_Sql.="option_tf = '".$spl_tf[$splKey]."' ";
                            $spl_Sql.= "WHERE option_num='".$spl_num[$splKey]."' ";
                            ...
                            $spl_optInsertSql.= "( option_code, productcode, option_price, option_quantity, option_quantity_noti, option_use, option_type, option_tf ) ";
                            $spl_optInsertSql.= "VALUES ( '".$splVal."', '".$prcode."', '".$spl_option_price[$splKey]."', '".$spl_option_quantity[$splKey]."', ";
                            $spl_optInsertSql.= " '".$spl_option_noti_qty[$splKey]."', '".$spl_option_use[$splKey]."', '1', '".$spl_tf[$splKey]."' ) RETURNING option_num ";
