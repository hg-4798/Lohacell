...
$mainBanner = mainBannerList(); //배너정보

$today_product = today_product();  //최근본상품
$top_cate= top_category(); //카테고리
$main_disp_goods= main_disp_goods(); //메인진열상품

$best_review= best_review_main();//베스트리뷰
$smartSearchBrand = smartSearchBrand(); //스마트 서치 브랜드
$smartSearchCategory = smartSearchCategory('', '1'); //스마트 서치 브랜드
...
function privercyMail(){
	window.open("<?=$Dir.FrontDir?>privercymail.php","privercyMail_pop","height=570,width=590,scrollbars=yes");
}
