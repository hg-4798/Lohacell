...
<div id="contents">
	<div class="main-wrap">
		<div style="position:relative;float:left;width:100%;height:auto;"><a href="http://shinwonmall.com/magazine/" target="_blank" style=""><img src="./data/shopimages/mainbanner/main_topbanner.jpg" style="display:block;max-width:100%;height:auto;"/></a></div>
		...
		<style>
		.new-arrivals-wrap .goods-item .thumb-img{height:420px;padding-bottom: 0%;}
		.new-arrivals-wrap .goods-item .thumb-img img{width:300px;height:300px;top:50%;left:50%;margin-top:-150px;margin-left:-150px;}
		.new-arrivals-wrap .goods-item .thumb-img-model img{width:400px;max-width:400px;height:400px;left:50%;margin-left:-200px;top:50%;margin-top:-190px;}
		</style>
