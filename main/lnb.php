...
if(!isset($lnb_flag)) global $lnb_flag;
switch($lnb_flag){
	case 1 :
...
<div class="cs-lnb">
	...
	<ul>
		...
		<li><a <?=$class_on['original']?>href="/front/customer/original.php">정품인증 안내</a></li>
		<li><a <?=$class_on['personal']?>href="/front/mypage_personal.php">1:1문의</a></li>
		<li><a <?=$class_on['store']?>href="/front/brand/store.php">매장안내</a></li>
		<li><a <?=$class_on['membership']?> href="/front/customer_grade.php">멤버십 등급/혜택안내</a></li>
	</ul>
</div>
<?	break;
} 
