		...
		<tr>
			...
			<tr>
				<td>
					...
					<div class="title_depth3">기획전 진열관리
						<div align="right">
						<a href="/admin/market_promotion_reg_test.php?mode=mod&pidx=<?=$pidx?>" target="_self">
			...
			<tr>
				...
				<?php
									...
									$sql.= "FROM tblproduct a left join tblproductlink b on(a.productcode=b.c_productcode and c_maincate=1) WHERE 1=1 "; //AND sabangnet_flag='N'
									$sql.= $qry." ";
...
<?php
		...
		?>
							...
							<td valign=top style="height: 1100px;">
								...
								<IFRAME name="MainPrdtFrame" src="market_promotion_product.main_test.php?pidx=<?=$pidx?>&special=<?=$special?>" width=100% height=100% frameborder=0 align=TOP scrolling="no" marginheight="0" marginwidth="0"></IFRAME>
