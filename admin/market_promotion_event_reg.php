...
$page_text = "이벤트";
$return_page_link = "market_promotion_event_list.php";
...
// 				echo "<script>document.location.href='market_promotion_new.php';</script>";
    ...
    case "ins_submit" : $ptitle = pmysql_escape_string($_POST["ptitle"]); $pinfo = $_POST["pinfo"]; $pseq = $_POST["pseq"]; $ptem = $_POST["ptem"]; $pppidx = $_POST["pppidx"];
        ...
        $misql.= "attendance_weekly_icon, attendance_weekend_icon ) ";
        ...
        $misql.="{$attendance_complete_reward_point}, '{$attendance_complete_reward_coupon}', ";
        $misql.="'{$up_file['attendance_weekly_icon'][0]['v_file']}', '{$up_file['attendance_weekend_icon'][0]['v_file']}' ) ";
...
?>
    ...
    <div class="content-wrap">
        <div class="title_depth3"><?=$page_text?> <?if($mode=="ins"){echo "등록";}else{echo "수정";} ?>
            <?if($page_type=="event" && $mode == "mod"){?>
                <a href="/front/promotion/event_detail.php?idx=<?=$pidx?>" target="_blank">
            ...
            <div class="table_style01 pt_20" style="position:relative">
                ...
                <table cellpadding=0 cellspacing=0 border=0 width=100%>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="event_type" value="2" checked onChange="javascript:changeEventType(this);" />댓글
                    ...
                    <tr>
                        <th style="border-top: 1px solid black; border-left: 1px solid black;">
                            ...
                            <div class="font_orange">(일반:390X260)</div>
                        </th>
                    ...
                    <tr>
                        <th style="border-top: 1px solid black; border-left: 1px solid black;">
                            ...
                            <div class="font_orange">(일반:750X400)</div>
                        </th>
                        <td style="border-top: 1px solid black; border-right: 1px solid black;">
