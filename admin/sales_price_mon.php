...
_render("report/sales_price_mon.html", $assign, 'admin/template');
...
/* $subquery = "
		...
		$subquery = "SELECT 	* 
			...
			AND o.ordercode not in ('2017052200280135018A','2017052202290002551A','2017052202361917530A','2017052209332677930A','2017052210004564220A','2017052211335760017A','2017081823011211354A','2017082911094138546A','2017120714063451079A','2018051918561554840AX')
			AND op.idx not in('18770','33418','33427','33428','33429','33627','33628','33689','33954','34043','34113','34214','34246','34262','34491','34538','34720','34741','34752','34821','34822','34888','34928','34395','35463','35474','35475','35058','35549','33100','33139','35749','50387','57757','65550','64395','67651','68678','69620','25463','73586','77201','78985','81102','81103','81173','81220','81456','81457','89948','89969','93936','93984','94032','94164','94189','94250','94265','94284','94312','94336','94394','94579','94592','94620','94693','94764','94790','94868','95041','95105','95171','95172','95186','95198','95216','95257','95291','95340','96122','96918','97030','97322','97306')
		   ...
		   SELECT 'sale' as saletype, o.ordercode, op.idx, min(o.id) as id, min(o.sender_name) as sender_name, min(o.paymethod) as paymethod, 
            ...
            AND o.ordercode not in ('2017052200280135018A','2017052202290002551A','2017052202361917530A','2017052209332677930A','2017052210004564220A','2017052211335760017A','2017081823011211354A','2017082911094138546A','2018051918561554840AX')
			AND op.idx not in('47616','47984','50387','57685','64935','71718','74141','74962','81238','89000','93969','93978','94340','95074')
			GROUP BY op.idx, o.ordercode
            UNION ALL 
		   ...
		   SELECT 'sale' as saletype, o.ordercode, op.idx, min(o.id) as id, min(o.sender_name) as sender_name, min(o.paymethod) as paymethod, 
            ...
            AND 	(o.oi_step2 >= 0 and o.oi_step2 < 45) 
             AND op.delivery_type IN ('0')
			AND o.ordercode not in ('2017112917371324603A','2017121313333944418A','2017121615565474628A','2017121621464957404A','2017120517484927256A','2018010421371895672A','2018020813181141318A','2018022012313116164A','2018031821122529613A','2018040900581158140A')
			AND op.idx not in('44020','50387','50420','50421','50395','48926','53070','54082','54071','54074','54075','54076','54078','54079','54080','54081','54883','54880','54879','57474','57570','57673','57714','55872','55892','59710','58984','60516','61391','61467','62370','63499','63500','65149','67672','68148','69407','69637','69146','69787','69975','70254','70431','72786','74142','78453','79793','78985','81220','79974','89969','93188','96359')
		   GROUP BY op.idx, o.ordercode
            UNION ALL 
           ...
           GROUP BY op.idx, o.pg_ordercode
			...
			LEFT join tblorderproduct op on ta.ordercode=op.ordercode and ta.idx = op.idx
			...
			AND ta.old_store_code=''
				AND o.ordercode not in('2017112917371324603A','2017120813325138412A','2017120813314141785A','2017121313333944418A','2017121615565474628A','2018010421371895672A','2018020516254967302A','2018020813181141318A','2018020818145467375A','2018022102014672371A','2018031301532958830A','2018020516155212626A','2018040623283390406A','2018031921475613110A')
				AND op.idx not in('52074','52069','57474','57714','59710','58984','61391','62370','63500','63636','65149','65997','65548','64394','64396','65549','67672','68012','68148','69146','69407','69621','69622','69637','69975','70266','70431','70454','72786','73580','73581','73582','73583','73584','73585','73586','73587','74676','77200','79793','72847','72848','81219','81455','81458','89947','93187','93189','96086')
			UNION ALL 
		   ...
		   SELECT 'sale' as saletype, o.ordercode, op.idx, min(o.id) as id, min(o.sender_name) as sender_name, min(o.paymethod) as paymethod, 
            ...
            AND 	(op.op_step >= 0 and op.op_step < 45) 
             AND op.delivery_type IN ('0')
             AND op.deli_date IS NOT NULL
			AND op.idx in ('33418','33418','33427','33428','33429','33627','33628','33689','33954','34043','34113','34214','34246','34262','34491','34538','34720','34741','34752','34821','34822','34888','34928','34395','35463','35474','35475','35058','35549','33100','33139','35749','67651','25463')
		   GROUP BY op.idx, o.ordercode
			UNION ALL 
		   ...
		   SELECT 'sale' as saletype, o.ordercode, op.idx, min(o.id) as id, min(o.sender_name) as sender_name, min(o.paymethod) as paymethod, 
            ...
            JOIN    (select ordercode, idx, min(regdt) as cfindt, 0 as rfee from tblorderproduct_store_change group by ordercode, idx) cp on o.ordercode = cp.ordercode and op.idx = cp.idx 
            WHERE   1=1 
            AND	    '20171221211000' >= '{$search_s}' and '20171221211000' <= '{$search_e}' 
			AND op.idx in ('57685','57757')
		   GROUP BY op.idx, o.ordercode
            UNION ALL 
		   ...
		   GROUP BY op.idx, o.ordercode
            ...
            JOIN    tblproductbrand v on op.vender = v.vender 
            WHERE   1=1 
            AND	    '20180504000000' >= '{$search_s}' and '20180504235959' <= '{$search_e}' 
			AND op.idx in ('89000')
		   GROUP BY op.idx, o.ordercode
			UNION ALL 
            ...
            JOIN    tblproductbrand v on op.vender = v.vender 
            WHERE   1=1 
            AND	    '20180523000000' >= '{$search_s}' and '20180523235959' <= '{$search_e}' 
            AND	    o.oi_step1 in ('1', '2', '3', '4') 
            AND 	(o.oi_step2 >= 0 and o.oi_step2 < 45) 
             AND op.delivery_type IN ('0','2')
			AND op.idx in ('93984','94032','94189','94250','94265','94284','94312','94336','94340','94394','94579','94592','94620','94693','94764','94790','94868','95041','95074','95105','95171','95186','95198','95257','95291','95340','94065','94500','95153','95251')
		   GROUP BY op.idx, o.ordercode
			UNION ALL 

            SELECT 'sale' as saletype, o.ordercode, op.idx, min(o.id) as id, min(o.sender_name) as sender_name, min(o.paymethod) as paymethod, 
                    min(o.oldordno) as oldordno, min(is_mobile) as is_mobile, 
                    '20180526161800' as cdt, 
                    op.productcode, min(op.productname) as productname, count(op.productname) as cnt_prod, 
					min(op.vender) as vender, min(v.brandname) as brandname,
                    sum( (op.price+op.option_price) * op.option_quantity) as op_ordprice, sum(op.coupon_price) as op_coupon, 
                    sum(op.use_point) as op_usepoint, sum(op.use_epoint) as op_useepoint, sum(o.deli_price) as o_deli_price, sum(op.deli_price) as op_deli_price, op.delivery_type 
            ...
            JOIN    tblproductbrand v on op.vender = v.vender 
            WHERE   1=1 
            AND	    '20180526000000' >= '{$search_s}' and '20180526235959' <= '{$search_e}' 
            AND	    o.oi_step1 in ('1', '2', '3', '4') 
            AND 	(o.oi_step2 >= 0 and o.oi_step2 < 45) 
             AND op.delivery_type IN ('0','2')
			AND op.idx in ('95037')
		   GROUP BY op.idx, o.ordercode
            ...
            JOIN    tblproductbrand v on op.vender = v.vender 
            WHERE   1=1 
            AND	    '20180615000000' >= '{$search_s}' and '20180615235959' <= '{$search_e}' 
            AND	    o.oi_step1 in ('1', '2', '3', '4') 
            AND 	(o.oi_step2 >= 0 and o.oi_step2 < 45) 
             AND op.delivery_type IN ('0')
			AND op.idx in ('97306')
		   GROUP BY op.idx, o.ordercode
            ...
            AND op.delivery_type IN ('2') 
			AND o.ordercode not in ('2017052200280135018A','2017052202290002551A','2017052202361917530A','2017052209332677930A','2017052210004564220A','2017052211335760017A','2017081823011211354A','2017082911094138546A','2018051918561554840AX')
			AND op.idx not in('18771','47984','50387','71718','74962','81238','93969','93978')
			...
			AND op.idx not in('18771','57685','64935','76211','76699')
			GROUP BY op.idx, o.ordercode, oc.cfindt
            UNION ALL 
            ...
            AND 	(o.oi_step2 >= 0 and o.oi_step2 < 45) 
            AND op.delivery_type IN ('0')
			AND o.ordercode not in ('2017112917371324603A','2017120714063451079A','2017121313333944418A','2017121615565474628A','2018010421371895672A','2018020813181141318A','2018051918561554840AX')
			AND op.idx not in('31971','50387','52074','52069','54082','54071','54074','54075','54076','54078','54079','54080','54081','57474','57714','59710','58984','60516','61391','62370','65149','65548','65549','64395','67672','68148','68678','69407','69620','69637','69146','69787','69975','70254','70431','72786','73586','77201','78985','79793','81102','81103','81173','81220','81456','81457','89969','93936','95172','95216','96086','96122','96918','97030','97322')
			GROUP BY op.idx, o.ordercode, cp.cfindt
			UNION ALL 
            ...
            AND	    o.oi_step1 in ('1', '2', '3', '4') 
            AND 	(o.oi_step2 >= 0 and o.oi_step2 < 45) 
			AND o.pg_ordercode in ('2017083111321061616A','2017083111335751622A','2018011211003508957A')
			GROUP BY op.idx, o.pg_ordercode, cp.cfindt
			UNION ALL 
            ...
            AND	    o.oi_step1 in ('1', '2', '3', '4') 
            AND 	(o.oi_step2 >= 0 and o.oi_step2 < 45) 
			AND o.ordercode in ('2017102610562741209A','2017112010593347698A','2018011211003508957A')
			GROUP BY op.idx, o.ordercode, cp.cfindt
            UNION ALL 

			SELECT 'refund' as saletype, o.ordercode, op.idx, min(o.id) as id, min(o.sender_name) as sender_name, min(o.paymethod) as paymethod, 
                    min(o.oldordno) as oldordno, min(is_mobile) as is_mobile, 
                    '20180404094000' as cdt, 
                    op.productcode, min(op.productname) as productname, count(op.productname) as cnt_prod, 
					min(op.vender) as vender, min(v.brandname) as brandname,
                    sum( (op.price+op.option_price) * op.option_quantity) as op_ordprice, sum(op.coupon_price + cp.rfee) as op_coupon, 
                    sum(op.use_point) as op_usepoint, sum(op.use_epoint) as op_useepoint, sum(o.deli_price) as o_deli_price, sum(op.deli_price) as op_deli_price, '0' as delivery_type
            ...
            JOIN    (select ordercode, idx, min(regdt) as cfindt, 0 as rfee from tblorderproduct_store_change group by ordercode, idx) cp on o.ordercode = cp.ordercode and op.idx = cp.idx 
            WHERE   1=1 
            AND	    '20180404000000' >= '{$search_s}' and '20180404000000' <= '{$search_e}' 
            AND op.delivery_type IN ('0') 
			AND op.idx in ('72849')
			GROUP BY op.idx, o.ordercode, cp.cfindt
            UNION ALL 
            ...
            JOIN    (select ordercode, idx, min(regdt) as cfindt, 0 as rfee from tblorderproduct_store_change group by ordercode, idx) cp on o.ordercode = cp.ordercode and op.idx = cp.idx 
            WHERE   1=1 
            AND	    '20180601000000' >= '{$search_s}' and '20180601000000' <= '{$search_e}' 
            AND op.delivery_type IN ('2') 
			AND op.idx in ('95037')
			GROUP BY op.idx, o.ordercode, cp.cfindt
			UNION ALL 

			select 'refund' as saletype,ta.ordercode as ordercode,op.idx as idx,o.id as id,	o.sender_name as sender_name,o.paymethod as paymethod,
				o.oldordno as oldordno,o.is_mobile as is_mobile,
				ta.regdt as cdt,
				op.productcode,op.productname as productname, 1 as cnt_prod,
				op.vender as vender,v.brandname as brandname,
...
<div class="content-wrap">
	<table cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			<td>
				<!-- 소제목 -->
				<div class="title_depth3_sub">월별 조회</span>
				</div>
			</td>
		</tr>
...
?>
								...
								<tr bgcolor=<?=$thiscolor?> onmouseover="this.style.background='#FEFBD1'" onmouseout="this.style.background='
									<?=$thiscolor?>'">
										<td>
											<?=substr($k, 0, 4)."-".substr($k, 4, 2)?>
										</td>
										...
										<td style="text-align:right;">
											<?=number_format($v['sale']['useepoint'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($v['sale']['real_price'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($v['sale']['real_price2'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
										...
										<td style="text-align:right;">
											<?=number_format($v['refund']['useepoint'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($v['refund']['real_price'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($v['refund']['real_price2'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($v['sale']['cnt_prod']-$v['refund']['cnt_prod'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
										...
										<td style="text-align:right;">
											<?=number_format($v['sale']['useepoint']-$v['refund']['useepoint'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($v['sale']['real_price']-$v['refund']['real_price'])?>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($v['sale']['real_price2']-$v['refund']['real_price2'])?>&nbsp;&nbsp;</td>
								</tr>
								<?
            $i++;
        }
?>
									<tr bgcolor="#d1d1d1" onmouseover="this.style.background='#FEFBD1'" onmouseout="this.style.background='#d1d1d1'">
										...
										<td style="text-align:right;">
											<b>
												<?=number_format($tot_sale_useepoint)?>
											</b>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<b>
										...
										<td style="text-align:right;">
											<b>
												<?=number_format($tot_sale_realprice2)?>
											</b>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<b>
										...
										<td style="text-align:right;">
											<b>
												<?=number_format($tot_refund_useepoint)?>
											</b>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<b>
										...
										<td style="text-align:right;">
											<b>
												<?=number_format($tot_refund_realprice2)?>
											</b>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<b>
												<?=number_format($tot_sale_cnt_prod - $tot_refund_cnt_prod)?>
											</b>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<b>
										...
										<td style="text-align:right;">
											<b>
												<?=number_format($tot_sale_useepoint - $tot_refund_useepoint)?>
											</b>&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<b>
										...
										<td style="text-align:right;">
											<b>
												<?=number_format($tot_sale_realprice2 - $tot_refund_realprice2)?>
											</b>&nbsp;&nbsp;</td>
									</tr>
									<?
		if($t_count==0) {
