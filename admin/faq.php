...
<form name=form1 action="<?=$_SERVER['PHP_SELF']?>" method=post>
		...
		<tr>
			<td>
				...
				<div class="title_depth3_sub">
					<span>운영자가 등록한 FAQ를 변경 및 삭제처리를 할 수 있습니다.</span>
				</div>
			</td>
		</tr>
			...
			<tr>
				<td>
					<div class="table_style01">
						...
						-->
									<textarea rows="2" cols="10" class="w200" name="faq_title" id="search" style="resize:none;vertical-align:middle;">
										<?=$faq_title?>
									</textarea>
								</TD>
	...
	?>
											...
											<option value="<?=$cate_row->num?>" <?=$selected[$cate_row->num]?>>
												<?=$cate_row->faq_category_name?>
											</option>
			...
			<tr>
				<td colspan=8 align=center>
					<a href="javascript:go_search();">
						<img src="images/btn_search01.gif">
					</a>
				</td>
			</tr>
			<tr>
...
?>
			...
			?>
							...
							<td align='right'>
								<a href="faq_register.php">
									<img src="/admin/images/btn_confirm_com.gif" border="0">
								</a>
							</td>
							<tr>
					</table>
