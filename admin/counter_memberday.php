...
<div class="content-wrap">
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">일자별 회원가입 수</div>
				</td>
			</tr>
			...
			<tr>
				...
				<tr>
					<td align=center><img src="graph/memberday.php?date=<?=$searchdate?>"></td>
				</tr>
<?php
/*
				if($searchdate>=date("Ym",strtotime('-1 month'))) {
					...
					WHERE date LIKE '{$searchdate}%' GROUP BY SUBSTR(date,7,2) ";
