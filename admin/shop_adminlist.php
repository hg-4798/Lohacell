		...
		<tr>
			<td>
				...
				<div class="title_depth3_sub">
					<span>운영자/부운영자 정보 관리 및 생성, 부운영자 별 메뉴 사용권한/접속제한 등을 설정할 수 있습니다.</span>
				</div>
			</td>
		</tr>
		<tr>
					...
					<div class="table_style01">
						<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
							<TR>
								...
								<td class="td_con1" width="35%">
									<input type=text name=up_id value="<?=$up_id?>" size=20 maxlength=20 <?=$id_readonly?> class="input" style="width:98%"></TD>
								<th width="200px">
									<span>이름</span>
								</th>
								<TD class="td_con1" width="35%">
									<input type=text name=adminname value="<?=$adminname?>" size=20 maxlength=20 <?=$disabled_form?> class="input" style="width:99%"></TD>
							</TR>
							<TR>
								<th>
									<span>비밀번호</span>
								...
								<TD class="td_con1">
									<input type=password name=passwd size=20 maxlength=20 <?=$disabled_form?> class="input" style="width:98%"></TD>
								<th>
									<span>비밀번호 확인</span>
								</th>
								<TD class="td_con1">
									<input type=password name=passwd2 size=20 maxlength=20 <?=$disabled_form?> class="input" style="width:99%"></TD>
							</TR>
							<TR>
								<th>
									<span>E-Mail</span>
								...
								<TD class="td_con1">
									<input type=text name=adminemail value="<?=$adminemail?>" size=30 maxlength=50 <?=$disabled_form?> class="input" style="width:98%"></TD>
								<th>
									<span>연락처</span>
								</th>
								<TD class="td_con1">
									<input type=text name=adminmobile value="<?=$adminmobile?>" size=30 maxlength=50 <?=$disabled_form?> class="input" style="width:99%"></TD>
							</TR>
							<TR>
								<th>
									<span>접근 IP 선택</span>
...
?>
							...
							<tr>
								<th>
									<span>접근 가능한 새로운 IP</span>
								</th>
								<TD class="td_con1" colspan="3">
									<textarea name=newips rows=3 cols=70 class="textarea" style="width:100%;height:50px" <?=$disabled_form?>></textarea>
									<br>
									<span class="font_orange">* 여러개 등록시 콤마(,)로 구분하여 입력</span>
								</TD>
							</tr>
							<?php
			if ($mode=="edit") {
...
?>
				...
				?>
									<tr>
										...
										<TD class="td_con1" colspan="3">
											<input type=radio id="idx_disabled1" name=disabled value="0" <?=$check_0?>
											<?=$disabled_disabled?>>
												<label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'"
												    for=idx_disabled1>로그인 허용</label> &nbsp;&nbsp;
												<input type=radio id="idx_disabled2" name=disabled value="1" <?=$check_1?>
												<?=$disabled_disabled?>>
													<label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'"
													    for=idx_disabled2>로그인 거부</label>
										</TD>
									</tr>
						</TABLE>
				</td>
...
?>
				<tr>
					<td align="center">
						<a href="javascript:CheckForm('<?=$mode?>');">
							<img src="<?=$button_value?>" border="0">
						</a>
					</td>
				</tr>
				<?php
