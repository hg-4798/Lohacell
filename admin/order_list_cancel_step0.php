...
<div class="admin_linemap"><div class="line"><p>현재위치 : 주문/매출  &gt; 주문조회 및 배송관리 &gt; <span>입금전 취소 관리</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">입금전 취소 관리</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>주문일자별 주문현황 및 주문내역을 확인/처리하실 수 있습니다.</span></div>
				</td>
			</tr>
...
<?php
		$sql = "SELECT  a.vender, v.brandname, a.ordercode, a.productcode, a.productname, a.opt1_name, a.opt2_name, a.quantity, (a.price+a.option_price) as  price, 
                        a.deli_com, a.deli_num, a.deli_date, a.deli_price, 
                        a.coupon_price, a.use_point, a.op_step, a.opt1_change, a.opt2_change, a.oc_no, a.date, a.idx, 
                        b.id, b.sender_name, b.paymethod, b.oi_step1, b.oi_step2, a.redelivery_type, b.is_mobile, a.delivery_type, a.store_code, a.reservation_date
                FROM {$qry_from} {$qry} 
		        ORDER BY a.ordercode {$orderby} , a.vender DESC
                ";
...
?>
			...
			<input type=hidden name="item_type" value="order_cancel_0">
