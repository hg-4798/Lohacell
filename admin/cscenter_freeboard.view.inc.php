    ...
    <tr>
        <td width="100%">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                <TR>
                    <TD background="images/table_top_line1.gif" colspan="6" width="762"><img src=img/table_top_line1.gif height=2></TD>
                </TR>
                <TR>
                    <TD class="board_cell1" >글제목</TD>
                    <TD colspan="5"><B><span class="font_orange"><?=$strSubject?></span></B></TD>
                </TR>
                <TR>
                ...
                <TR>
                    <TD class="board_con1" width="753" colspan="6">
                ...
                <TR height=40>
                    <TD WIDTH="100%"><p align="right">
                            ...
                            <?if($_ShopInfo->id == $this_id){?>
                                <A HREF="<?=$_SERVER['PHP_SELF']?>?exec=modify&num=<?=$num?>&s_check=<?=$s_check?>&search=<?=$search?>&block=<?=$block?>&gotopage=<?=$gotopage?>" class="btn-basic h-small">수정하기</A>

                                <A HREF="<?=$_SERVER['PHP_SELF']?>?exec=delete&num=<?=$num?>&s_check=<?=$s_check?>&search=<?=$search?>&block=<?=$block?>&gotopage=<?=$gotopage?>" class="btn-basic h-small">삭제하기</A>
                            <?}?>
                            <A HREF="<?=$_SERVER['PHP_SELF']?>?exec=write" class="btn-basic h-small">글쓰기</A>

                            <A HREF="<?=$_SERVER['PHP_SELF']?>?s_check=<?=$s_check?>&search=<?=$search?>&block=<?=$nowblock?>&gotopage=<?=$gotopage?>" class="btn-basic h-small">목록보기</A>
