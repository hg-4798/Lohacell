...
#---------------------------------------------------------------
	...
	if ( $mode == "delete" ) {
		...
		echo "<html></head><body onload=\"alert('삭제가 완료되었습니다.'); parent.location.href = 'community_lookbook_list.php'; \"></body></html>";exit;
	}
...
<div class="content-wrap">
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">LOOKBOOK 정보관리<span>LOOKBOOK의 정보를 수정/삭제 하실 수 있습니다.</span></div>
					<!-- 소제목 -->
