...
<div class="admin_linemap"><div class="line"><p>현재위치 : 디자인관리 &gt; 개별디자인-메인, 카테고리 &gt;<span>상품상세 화면 꾸미기</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">상품상세 화면 꾸미기</div>
					<div class="title_depth3_sub"><span>상품상세 화면 디자인을 자유롭게 디자인 하실 수 있습니다.</span></div>
				</td>
			</tr>			
			<tr>
				<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub">상품상세 화면 개별디자인</div>
				</td>
			</tr>
			...
			<tr>
				...
				<TR>
					<TD bgcolor="#f8f8f8" valign="top" style="padding:8pt;" width="48%"><button title="전체 트리확장" id="btn_treeall" class="btn" onmouseover="if(this.className=='btn'){this.className='btnOver'}" onmouseout="if(this.className=='btnOver'){this.className='btn'}" unselectable="on" onclick="AllOpen();"><IMG SRC="images/category_btn1.gif" WIDTH=22 HEIGHT=23 border="0"></button>
					...
					<TD align="center" width="55"><img src="images/btn_next1.gif" width="25" height="25" border="0" hspace="5"></TD>
					<TD align="center" bgcolor="#f8f8f8" style="padding:5pt;" width="48%"><p align="center"><b>&quot;모든 카테고리 일괄 개별디자인&quot; </b>을 적용할 경우 개별 디자인 사용중인 카테고리를 제외한 템플릿을 사용하는 모든 카테고리가 개별디자인으로 일괄 변경됩니다.<br><img id="preview_img" style="display:none" width="150" height="184" border="0" vspace="5" class="imgline"><p align="left"></TD>
				</TR>
				</TABLE>
				</td>
			</tr>
