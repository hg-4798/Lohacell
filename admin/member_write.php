...
if ($id) {
    ...
    $selected[email_com][$email_com]="selected";
...
function CheckFormSubmit(){
	...
	if (id_checked == '1' && passwd_checked == '1' && name_checked == '1' && birth_checked == '1' && home_addr_checked == '1' && email_checked == '1' && mobile_checked == '1' )
	{
				...
				<td>
					...
					<tr>
						...
						<td class="td_con1">
							...
							<input type="radio"  name="gender" id="idx_gender2" value="2"  <?=$data->gender=='2'?' checked':''?>/>
