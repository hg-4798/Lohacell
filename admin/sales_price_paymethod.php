...
_render("report/sales_price_paymethod.html", $assign, 'admin/template');
...
<div class="content-wrap">
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td>
				...
				<div class="title_depth3_sub">
					<span>결제수단별 내역을 확인하실 수 있습니다.</span>
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<!-- 소제목 -->
				<div class="title_depth3_sub">결제수단별 조회</span>
				</div>
			</td>
		</tr>
								...
								<tr bgcolor=<?=$thiscolor?> onmouseover="this.style.background='#FEFBD1'" onmouseout="this.style.background='
									<?=$thiscolor?>'">
										...
										<td style="text-align:right;">
											<?=number_format($ord_price)?>&nbsp;&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($rfd_price)?>&nbsp;&nbsp;&nbsp;</td>
										<td style="text-align:right;">
											<?=number_format($real_price)?>&nbsp;&nbsp;&nbsp;</td>
										<td style="text-align:right;">
...
?>
									<tr bgcolor=<?=$thiscolor?> onmouseover="this.style.background='#FEFBD1'" onmouseout="this.style.background='
										<?=$thiscolor?>'">
											...
											<td style="text-align:right;">
												<b>
													<?=number_format($price_tot)?>
												</b>&nbsp;&nbsp;&nbsp;</td>
											<td style="text-align:right;">
												<b>
													<?=number_format($cancel_price_tot)?>
												</b>&nbsp;&nbsp;&nbsp;</td>
											<td style="text-align:right;">
												<b>
													<?=number_format($price_tot + $cancel_price_tot)?>
												</b>&nbsp;&nbsp;&nbsp;</td>
											<td style="text-align:right;">
												<b>
													<?=number_format(100, 2)?>%</b>&nbsp;&nbsp;&nbsp;</td>
									</tr>
									<?
		if($t_count==0) {
