...
if(strlen($code)==12) {
	$sql = "SELECT type, list_type FROM tblproductcode WHERE code_a='".substr($code,0,3)."' ";
...
?>
		...
		<tr>
			...
			<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
			<TR>
				<TD><IMG SRC="images/product_register_stitle1.gif" WIDTH="192" HEIGHT=31 ALT=""></TD>
...
?>
			...
			<TR>
				...
				<TD class="td_con1" colspan="3"><input name=productname value="<?=str_replace("\"","&quot",$_data->productname)?>" size=80 maxlength=250 onKeyDown="chkFieldMaxLen(250)" class="input" style=width:100%></TD>
			</TR>
			<TR>
				<TD colspan="4" background="images/table_con_line.gif"></TD>
			</TR>
...
?>
			...
			<TR>
				...
				<?php } ?>
				<TD class="td_con1"><input name=sellprice value="<?=$_data->sellprice?>" size=16 maxlength=10 class="input" style=width:98% <?=($_data->assembleuse=="Y"?"disabled style='background:#C0C0C0'":"")?>><br><span class="font_orange" style="font-size:8pt;">* 코디/조립 사용시 판매가격 등록불가<br><b>&nbsp;&nbsp;</b>및 상품옵션, 패키지그룹 사용불가</span></TD>
				<TD class="table_cell" style="border-left-width:1pt; border-color:rgb(227,227,227); border-top-style:none; border-right-style:none; border-bottom-style:none; border-left-style:solid;"><img src="images/icon_point2.gif" width="8" height="11" border="0"><span class="font_orange"><b><?=($gongtype=="Y"?"시작가":"시중가격")?></b></span></TD>
				<TD class="td_con1"><input name=consumerprice value="<?=(int)(ord($_data->consumerprice)?$_data->consumerprice:"0")?>" size=16 maxlength=10 class="input" style=width:100%><br><span class="font_orange">* <strike>5,000</strike>로 표기됨, 0 입력시 표기안됨&nbsp;</span><br><br></TD>
			</tr>
			<?php } ?>
			<TR>
				<TD colspan="4" background="images/table_con_line.gif"></TD>
...
?>
	...
	<tr>
		...
		<tr>
			...
			<TABLE WIDTH="100%" BORDER=0 CELLPADDING=0 CELLSPACING=0>
			<TR>
				<TD><IMG SRC="images/design_eachjoin_stitle2.gif" WIDTH="192" HEIGHT=31 ALT=""></TD>
				<TD width="100%" background="images/shop_basicinfo_stitle_bg.gif"></TD>
				<TD><IMG SRC="images/shop_basicinfo_stitle_end.gif" WIDTH=10 HEIGHT=31 ALT=""></TD>
			</TR>
			</TABLE>
...
?>
				...
				<?php if($popup!="YES"){?><A HREF="javascript:parent.location='product_option.php';"><B><img src="images/btn_option.gif" width="105" height="18" border="0" hspace="2" align=absmiddle></B></A><?php }?>
