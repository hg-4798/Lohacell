...
//취소가능 주문상품
$mileage_expect = 0;
$order_product = $Order->getProductGroup("order_num='{$order_num}' AND order_status=1 AND cs_type='0'");
if(!$order_product) {
	alert_go('취소가능한 상품이 없습니다.','c');
}
...
_render("order/cancel.html", $assign, 'admin/template');
