...
if($type=="update" && ord($body)) {
	...
	$onload="<script>window.onload=function(){ alert(\"브랜드맵 화면 디자인 수정이 완료되었습니다.\"); }</script>";
} elseif($type=="delete") {
	...
	pmysql_query($sql,get_db_conn());
	DeleteCache("tblshopinfo.cache");
	$onload="<script>window.onload=function(){ alert(\"브랜드맵 화면 디자인 삭제가 완료되었습니다.\"); }</script>";
} elseif($type=="clear") {
	$intitle="";
	$body="";
...
<div class="admin_linemap"><div class="line"><p>현재위치 : 디자인관리 &gt; 개별디자인-페이지 본문 &gt;<span>브랜드맵 화면 꾸미기</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
                    <!-- 페이지 타이틀 -->
					<div class="title_depth3">브랜드맵 화면 꾸미기</div>
					<div class="title_depth3_sub"><span>브랜드맵 화면 디자인을 자유롭게 디자인 하실 수 있습니다.</span></div>
                </td>
            </tr>
            <tr>
            	<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub">쇼핑몰 브랜드맵 개별디자인</div>
                </td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td align="center"><a href="javascript:CheckForm('update');"><img src="images/botteon_save.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:CheckForm('clear');"><img src="images/botteon_bok.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:CheckForm('delete');"><img src="images/botteon_del.gif" border="0" hspace="0"></a></td>
			</tr>
			</form>
			...
			<tr>
				<td>
					...
					<div class="sub_manual_wrap">
						...
						<dl>
							<dt><span class="point_c1">브랜드맵 화면 매크로명령어</span><span>(해당 매크로명령어는 다른 페이지 디자인 작업시 사용이 불가능함)</span></dt>
							<dd>
...
<FONT class=font_blue>   [IFBRANDMAP]
   ...
   [IFENDBRANDMAP]</pre>
						...
						<tr><td colspan=2 height=1 bgcolor=#dddddd></td></tr>
						<tr>
							<td class=table_cell align=right style="padding-right:15">브랜드맵 스타일 정의</td>
							<td class=td_con style="padding-left:5;word-break:break-all;">
