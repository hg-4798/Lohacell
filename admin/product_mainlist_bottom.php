...
<div class="admin_linemap"><div class="line"><p>현재위치 : 상품관리 &gt; 카테고리/상품관리 &gt;<span>메인 하단 상품 진열관리</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">메인 하단 상품 진열관리</div>
					<!-- 소제목 -->
					<div class="title_depth3_sub"><span>쇼핑몰 메인 하단에 진열될 상품을 등록할 수 있습니다.</span></div>
				</td>
			</tr>
			<tr>
				<td>
...
<?php
		...
		?>
							...
							<td valign=top style="height: 1100px;">
								<!-- 소제목 -->
								<div class="title_depth3_sub">메인 하단 진열 리스트</div>
<?
                                $iframeSrc = "product_mainlist.main_bottom.php";
?>
