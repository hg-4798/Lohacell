...
//$cooper_reserve_ori	= trim($_REQUEST['cooper_reserve_ori']);		// 제휴사적립금(이전)
...
*/
	...
	alert_go("{$id} 회원님의 개인정보 수정이 완료되었습니다.\\n\\n감사합니다.","member_write.php?id={$id}");

}else if($mode=="insert"){/// 어느 페이지에서 회원추가 되는지 확인 
	...
	alert_go("{$id} 회원님의 개인정보 등록이 완료되었습니다.\\n\\n감사합니다.","member_list.php");
}
