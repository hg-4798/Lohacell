    ...
    <form name=writeForm method='post' action='<?= $_SERVER['PHP_SELF']?>' enctype='multipart/form-data'>
        ...
        <div class="table_style01">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                <TR>
                    <td class="board_cell1" ><span>글제목</span></td>
                    <TD class="td_con1" align="center" colspan="5"><p align="left"><INPUT maxLength=200 size=70 name=up_subject value="<?=$thisBoard['title']?>" style="width:100%" class="input"></TD>
                </TR>
                <TR>
                    <td class="board_cell1" ><span>글쓴이</span></td>
                    <TD align="center" height="30" class="td_con1"><p align="left"><?=$thisBoard['name']?>
                    <td class="board_cell1" ><span>아이디</span></td>
                    <TD align="center" height="30" class="td_con1" colspan="3"><p align="left"><?=$thisBoard['id']?>
                </TR>
                <TR>
                    <td class="board_cell1" ><span>글내용</span></td>
        ...
        <div align=center>
            <img src="<?=$img?>/btn_input02.gif" border=0 style="cursor:hand;" onclick="chk_writeForm(document.writeForm);"> &nbsp;&nbsp;
            <IMG SRC="<?=$img?>/btn_list.gif" border=0 style="CURSOR:hand" onClick="history.go(-1);">
        </div>
    </form>
    <?php
}
