	...
	<form name="form1" action="<?=$_SERVER['PHP_SELF']?>" method="post">
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub">사업자 등록정보
						<span>쇼핑몰 회사소개/하단/이용안내/정보보호 등에서 출력됨으로 정확히 입력해야 합니다.</span>
					</div>
				</td>
			</tr>
			<tr>
					...
					<div class="table_style01">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="td_con1">
									<input type="text" name="up_companyname" value="<?=$companyname?>" size="60" maxlength="30" onKeyDown="chkFieldMaxLen(30)" class="input">
								</td>
							</tr>
							<tr>
								<th>
								...
								<td class="td_con1">
									<input type="text" name="up_companynum" value="<?=$companynum?>" size="20" maxlength="20" class="input">
								</td>
							</tr>
							<tr>
								<th>
								...
								<td class="td_con1">
									<input type="text" name="up_companyowner" value="<?=$companyowner?>" size="40" maxlength="20" onKeyDown="chkFieldMaxLen(20)" class="input">
								</td>
							</tr>
							<tr>
								<th>
								...
								<td class="td_con1">
									<input type=text name="up_companypost1" id="up_companypost1" value="<?=substr($companypost,0,3)?>" size="3" maxlength="3" class="input"> -
									<input type=text name="up_companypost2" id="up_companypost2" value="<?=substr($companypost,3,3)?>" size="3" maxlength="3" class="input">
									<button type="button" class="btn btn-form btn-info" onclick="openDaumPostcode();">
										<i class="fa fa-search"></i> 주소찾기</button>
									<div class="m-t-5">
										<input type=text name="up_companyaddr" id="up_companyaddr" value="<?=$companyaddr?>" size="60" maxlength="150" onKeyDown="chkFieldMaxLen(150)" class="input">
									</div>
							...
							<tr>
								...
								<td class="td_con1">
									<input type="text" name="up_companybiz" value="<?=$companybiz?>" size="60" maxlength="30" onKeyDown="chkFieldMaxLen(30)" class="input">
								</td>
							</tr>
							<tr>
								<th>
								...
								<td class="td_con1">
									<input type=text name="up_companyitem" value="<?=$companyitem?>" size="60" maxlength="30" onKeyDown="chkFieldMaxLen(30)" class="input">
								</td>
							</tr>
							<tr>
								<th>
								...
								<td class="td_con1">
									<input type=text name="up_reportnum" value="<?=$reportnum?>" size="20" maxlength="20" class="input">
								</td>
							</tr>
						</table>
					</div>
			...
			<tr>
				<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub">쇼핑몰 정보 설정
						<span>쇼핑몰 정보를 바탕으로 각종 내용이 표기됩니다. 정확히 입력해 주세요!</span>
					</div>
				</td>
			</tr>
			<tr>
					...
					<div class="table_style01">
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="td_con1">
									<input type=text name="up_shopname" value="<?=$shopname?>" size="60" maxlength="50" onKeyDown="chkFieldMaxLen(50)" class="input">
								</td>
							</tr>
							<tr>
								<th>
									<span>쇼핑몰 운영자 이메일</span>
								</th>
								<td class="td_con1">
									<input type=text name="up_info_email" value="<?=$info_email?>" size="60" maxlength="50" onKeyDown="chkFieldMaxLen(50)" class="input">
								</td>
							</tr>
							<tr>
								<th>
								...
								<td class="td_con1">
									<input type=text name="up_info_tel" value="<?=$info_tel?>" size="60" maxlength="100" onKeyDown="chkFieldMaxLen(100)" class="input">
									<span class="font_blue">* 여러개 입력시 콤마(,)를 입력하세요.</span>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td class="td_con1">
									<input type=text name="up_info_fax" value="<?=$info_fax?>" size="60" maxlength="100" onKeyDown="chkFieldMaxLen(100)" class="input">
									<span class="font_blue">* 여러개 입력시 콤마(,)를 입력하세요.</span>
								</td>
							</tr>
							<tr>
								...
								<td class="td_con1">
									<input type=text name="up_info_addr" value="<?=$info_addr?>" size="60" maxlength="150" onKeyDown="chkFieldMaxLen(150)" class="input">
								</td>
							</tr>
							<tr>
								<th>
									<span>개인정보 담당자 이름</span>
								</th>
								<td class="td_con1">
									<input type="text" name="up_privercyname" value="<?=$privercyname?>" size="20" maxlength="10" onKeyDown="chkFieldMaxLen(10)" class="input">
								</td>
							</tr>
							<tr>
								<th>
									<span>개인정보 담당자 이메일</span>
								</th>
								<td class="td_con1">
									<input type="text" name="up_privercyemail" value="<?=$privercyemail?>" size="60" maxlength="50" onKeyDown="chkFieldMaxLen(50)" class="input">
								</td>
							</tr>
							<tr>
								<th>
								...
								<td class="td_con1">
									<input type="text" name="up_ir" value="<?=$ir?>" size="60" maxlength="50" onKeyDown="chkFieldMaxLen(50)" class="input">
								</td>
							</tr>
						</table>
					</div>
