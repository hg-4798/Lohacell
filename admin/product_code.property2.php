...
if ($mode=="insert" && ord($up_code_name)) {
	...
	if ($insert) {
		...
		//카테고리 수정
		echo "<script>parent.document.form1.action='product_code_indb.php';parent.document.forms[0].submit();</script>";
	...
	if ($mode_result=="result" && $up_code_name) {	//수정내역 업데이트
		...
		if ($update) {
			...
			echo "<script>parent.document.form1.action='product_code_indb.php';parent.document.form1.submit();</script>";
...
function Save() {
	...
	*/
	...
	if (document.form1.up_detail_type.value.length==0) {
		...
		if(document.form1.gong[0].checked) {
			if(detail_type!="A" && detail_type!="T") {
				alert("상품상세 디자인을 선택하세요.");
				DesignDetail(0);
				return;
			}
...
<tr>
	<td width="100%" bgcolor="#FFFFFF">
		...
		<!-- 소제목 -->
		<div class="title_depth3_sub">카테고리 속성<span>카테고리 추가, 수정, 삭제가 가능하며 카테고리별 템플릿을 선택할 수 있습니다.</span></div>
...
?> 
	...
	<tr>
		<th><span>카테고리 상품진열</span></th>
		<TD class="td_con1"><input type=checkbox id="idx_special1" name=tmp_special value="1" <?php if($special["1"]=="Y")echo"checked";?>> <label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_special1>신규상품</label>
...
<FONT COLOR="red">라인별 상품수 :</FONT>
		...
		<input type=checkbox id="idx_special0" name=tmp_special value="2" <?php if($special["2"]=="Y")echo"checked";?>> <label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_special0>인기상품</label>
		- <FONT COLOR="red">진열타입 선택 :</FONT>
		...
		<input type=checkbox id="idx_special2" name=tmp_special value="3" <?php if($special["3"]=="Y")echo"checked";?>> <label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_special2>추천상품</label>
		- <FONT COLOR="red">진열타입 선택 :</FONT>
		...
		<br>
		<input type=checkbox id="idx_islist" name=up_islist value="Y" <?php if($islist=="Y")echo"checked";?> > <label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_islist>카테고리상품목록</label><br>
	...
	<tr>
		<th><span>상품진열 템플릿 선택</span></th>
		<TD class="td_con1">
        <div class="table_none">
		<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td><input type=radio id="idx_gong1" name=gong value="N" <?php if($gong=="N" || ord($gong)==0) echo " checked"?> onclick="DesignMsg(0)"> <label style='cursor:hand;' onmouseover="style.textDecoration='underline'" onmouseout="style.textDecoration='none'" for=idx_gong1>상품 진열 및 상품상세 디자인(일반형)</label></td>
		</tr>
		<tr>
			...
			<col width=50%></col>
			<tr>
				<td><a href="javascript:DesignList(0);"><img src="images/product_displaylist1.gif" border="0"></a></td>
				<td><a href="javascript:DesignDetail(0);"><img src="images/product_displaydetail1.gif" border="0"></a></td>
			</tr>
			<?php if($gong == "N" && $list_type!="" && $detail_type!="") {?>
			<tr>
				<td align=center valign="top" style="padding-top:3pt;"><a href="javascript:DesignList(0);"><img src="images/product/<?=$list_type?>.gif" border="0" style="border-width:1pt; border-color:rgb(222,222,222); border-style:solid;"></a></td>
				<td align=center valign="top" style="padding-top:3pt;"><a href="javascript:DesignDetail(0);"><img src="images/product/<?=$detail_type?>.gif" border="0" style="border-width:1pt; border-color:rgb(222,222,222); border-style:solid;"></a></td>
			</tr>
			<?php } else { ?>
			<tr>
				<td align=center valign="top" style="padding-top:3pt;"><a href="javascript:DesignList(0);"><img src="images/ex1.gif" border="0" style="border-width:1pt; border-color:rgb(222,222,222); border-style:solid;"></a></td>
				<td align=center valign="top" style="padding-top:3pt;"><a href="javascript:DesignDetail(0);"><img src="images/ex2.gif" border="0" style="border-width:1pt; border-color:rgb(222,222,222); border-style:solid;"></a></td>
			</tr>
			<?php } ?>
			</table>
			</td>
