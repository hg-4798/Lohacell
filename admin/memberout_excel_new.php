...
foreach ( $est as $key => $val ) {
    $field_name_list .= "<th>" . $arr_admin_memberout_excel_info[$val][0] . "</th>";
    $sql .= $arr_admin_memberout_excel_info[$val][1] . ",";
	if (trim($arr_admin_memberout_excel_info[$val][0]) == utf8encode('통합포인트')) $reserve_num	= $key;
}
