...
global $_ShopInfo;
$fp = file(DOC_ROOT.DIRECTORY_SEPARATOR.DIR_ADMIN."/_config/menu_product.txt");
...
foreach($fp as $v){
	...
	if(substr($v,0,1) == "[" && substr($v,-1,1) == "]"){
		...
		$tmp = explode('= ',$v);
		if( trim($tmp[0]) && substr(trim($tmp[0]), 0, 1) != '#' ){
...
<div class="admin_lnb_wrap">
	<div class="close_btn" style="display:none" id="close_img_off"><a href="javascript:hiddenLeft()"><img src="/admin/img/btn/admin_lnb_open.gif" alt="OPEN" /></a></div>
	<div class="container" id="leftMenus">

		<div class="close_btn"><a href="javascript:hiddenLeft()"><img src="/admin/img/btn/admin_lnb_close.gif" alt="CLOSE" /></a></div>
		
		<div class="admin_name">
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					<th><?=$_ShopInfo->id?><span> 접속중</span></th>
					<td><a href="logout.php"><img src="/admin/img/btn/admin_lnb_logout.gif" alt="로그아웃" /></a></td>
				</tr>
			</table>
		</div>
		...
		<div class="lnb_menu_wrap">
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					<th><img src="/admin/img/common/admin_lnb_round_top.gif" alt="" /></th>
					<tr>
						<td>
					...
					<tr><th><img src="/admin/img/common/admin_lnb_round_bottom.gif" alt="" /></th></tr>
				</tr>
			</table>
		</div>
