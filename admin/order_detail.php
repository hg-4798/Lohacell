...
$receiver_address=reset(explode("  ",$address));
$receiver_address_detail=end(explode("  ",$address));
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<div class="input-wrap">
							<input type="text" name="receiver_address" id="receiver_address" title="주소" value="<?=$receiver_address?>" style="width:600px;" <?=$read_only ?>>
                            <input type="text" name="receiver_address_detail" id="receiver_address_detail" title="상세주소" value="<?=$receiver_address_detail?>" style="width:600px;" <?=$read_only ?>>
						</div>
					</td>
				</tr>
				<tr>
