...
if ($type	=='name') {
	...
	while($row = pmysql_fetch_array($result)) {
		...
		$remot_file_img_MB	= $remot_file_path2.'_ZZZ.jpg';
		$remot_file_img_MB_C	= $remot_file_path2.'_ZZZ.JPG';
		...
		$remot_file_img_MM	= $remot_file_path2.'_ZZ.jpg';
		$remot_file_img_MM_C	= $remot_file_path2.'_ZZ.JPG';
		...
		$remot_file_img_MS	= $remot_file_path2.'_Z.jpg';
		$remot_file_img_MS_C	= $remot_file_path2.'_Z.JPG';		
		...
		if(remoteFileExist($remot_file_img_MB) == 1) {
			$remot_file_path_B = $remot_file_img_MB;
		}else if(remoteFileExist($remot_file_img_MB_C) == 1) {
			$remot_file_path_B = $remot_file_img_MB_C;
		}else if(remoteFileExist($remot_file_img_EB) == 1) {
			$remot_file_path_B = $remot_file_img_EB;
		}else if(remoteFileExist($remot_file_img_EB_C) == 1) {
			$remot_file_path_B = $remot_file_img_EB_C;
		}else if(remoteFileExist($remot_file_img_B) == 1) {
			$remot_file_path_B = $remot_file_img_B;
		}else{
			$remot_file_path_B = $remot_file_img_B_C;
		}

		if(remoteFileExist($remot_file_img_MM) == 1) {
			$remot_file_path_M = $remot_file_img_MM;
		}else if(remoteFileExist($remot_file_img_MM_C) == 1) {
			$remot_file_path_M = $remot_file_img_MM_C;
		}else if(remoteFileExist($remot_file_img_EM) == 1) {
			$remot_file_path_M = $remot_file_img_EM;
		}else if(remoteFileExist($remot_file_img_EM_C) == 1) {
			$remot_file_path_M = $remot_file_img_EM_C;
		}else if(remoteFileExist($remot_file_img_M) == 1) {
			$remot_file_path_M = $remot_file_img_M;
		}else{
			$remot_file_path_M = $remot_file_img_M_C;
		}

		if(remoteFileExist($remot_file_img_MS) == 1) {
			$remot_file_path_S = $remot_file_img_MS;
		}else if(remoteFileExist($remot_file_img_MS_C) == 1) {
			$remot_file_path_S = $remot_file_img_MS_C;
		}else if(remoteFileExist($remot_file_img_ES) == 1) {
			$remot_file_path_S = $remot_file_img_ES;
		}else if(remoteFileExist($remot_file_img_ES_C) == 1) {
			$remot_file_path_S = $remot_file_img_ES_C;
		}else if(remoteFileExist($remot_file_img_S) == 1) {
