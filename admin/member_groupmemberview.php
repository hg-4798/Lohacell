...
<div class="content-wrap">
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">등급별 회원관리 <span>등급별 등록된 회원정보를 조회/관리가 가능합니다.</span></div>
				</td>
			</tr>
			<tr>
				<td>
				...
				<tr>
					<td width="100%" >
					<table cellpadding="0" cellspacing="0" width="100%" bgcolor="white" class="m-t-20">
					<tr>
						<td width="100%">
...
<?php
		if (ord($group_code)) {
			...
			while($row=pmysql_fetch_object($result)) {
				...
				$cnt++;
				$email = Common::Dectypt_AES128CBC($row->email);
				...
				echo "	<TD><a href=\"javascript:MemberMail('{$email}');\"><img src=\"images/icon_mail.gif\" border=\"0\"></a></td>\n";
			...
			if ($cnt==0) {
				echo "<tr><td colspan=8 align=center>등급내 검색된 회원이 없습니다.</td></tr>";
			}
		} else {
			echo "<tr><td colspan=8 align=center>등급내 검색된 회원이 없습니다.</td></tr>";
		}
