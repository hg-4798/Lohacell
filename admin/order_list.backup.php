...
if($file_size < $maxfilesize) {
	...
	if ($mode=="insert") {
		...
		foreach($category as $k){
			...
			$query="insert into tblproductlink (c_productcode,c_category,c_maincate) values ('".$prcode."','".$k."','".$maincate."')";
...
?>
		...
		<?php
								...
								pmysql_free_result($result);
		?>
								</select> <A HREF="product_package.php"><B><img src="images/btn_package.gif" border="0" hspace="2" align=absmiddle></A>
								</td>
							</tr>
							</table>
							</td>
