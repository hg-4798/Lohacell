			...
			<div class="contentsBody">
				...
				<table class="th-left" >
					...
					<tbody>
						...
						<tr>
							<th scope="col">이름</th>
							<td><input type="text" name="name" id="name" value="<?=$mem_name?>" title="이름을 입력하세요." readonly="readonly"></td>
						</tr>

						<tr>
							<th scope="col">생년월일</th>
							<td>
                                <input name="birth1" title="생년월일을 입력하세요." type="text" size="8" maxlength="8" value="<?=$mem_birth?>" label="생년월일" class="w80" readonly="readonly">&nbsp;&nbsp;&nbsp
								<input type="radio" name="lunar" id="idx_lunar1" value="1"<?=$mem_lunar==""||$mem_lunar=="1"?" checked":""?>   disabled="disabled"/> <label for="idx_lunar1">양력</label>
								<input type="radio" name="lunar" id="idx_lunar2" value="0"<?=$mem_lunar=="0"?" checked":""?>   disabled="disabled"/> <label for="idx_lunar2">음력</label>
							</td>
						</tr>
						...
						<tr>
							<th scope="col">성별</th>
							<td>
								<input type="radio" name="gender" id="idx_gender1" value="1"<?=$mem_gender==""||$mem_gender=="1"?" checked":""?>   disabled="disabled"/> <label for="idx_gender1">남자</label>
								<input type="radio" name="gender" id="idx_gender2" value="2"<?=$mem_gender=="0"?" checked":""?>   disabled="disabled"/> <label for="idx_gender2">여자</label>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
                                <select name="mobile[]" id="mobile1" class="w50" disabled="disabled">
							...
							- <input type="text" name="mobile[]" id="mobile2" maxlength="4" value="<?=$mobile[1]?>" size="6" style="ime-mode:disabled;" onKeypress="if(event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"  class="w50" readonly="readonly"/>
							- <input type="text" name="mobile[]" id="mobile3" maxlength="4" value="<?=$mobile[2]?>" size="6" style="ime-mode:disabled;" onKeypress="if(event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"  class="w50" title="휴대폰번호를 입력해 주세요." readonly="readonly"/>
							</td>
						</tr>
						<tr>
							<th scope="col">이메일</th>
						...
						<tr>
							...
							<td>
                                <input type="radio" name="skintype" id="skintype1" value="1"<?=$skintype==1?"checked":""?> /> <label for="skintype1">FACE</label>
                                <input type="radio" name="skintype" id="skintype2" value="2"<?=$skintype==2?"checked":""?> /> <label for="skintype2">LIP</label>
                                <input type="radio" name="skintype" id="skintype3" value="3"<?=$skintype==3?"checked":""?> /> <label for="skintype3">EYE</label>
                                <input type="radio" name="skintype" id="skintype4" value="4"<?=$skintype==4?"checked":""?> /> <label for="skintype4">CHEEK</label>
                                <input type="radio" name="skintype" id="skintype5" value="5"<?=$skintype==5?"checked":""?> /> <label for="skintype5">SKINCARE</label>
                                <!--
                                <input type="radio" name="skintype" id="skintype6" value="6"<?=$skintype==6?"checked":""?> /> <label for="skintype6">민감성(과민감성)</label>
                                <input type="radio" name="skintype" id="skintype7" value="7"<?=$skintype==7?"checked":""?> /> <label for="skintype7">아토피</label>
                                -->
                                <input type="radio" name="skintype" id="skintype0" value="0"<?=$skintype==0?"checked":""?> /> <label for="skintype0">없음</label>
							</td>
						</tr>
                        <!--
