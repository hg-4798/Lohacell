...
<div class="admin_linemap"><div class="line"><p>현재위치 : 상품관리 &gt; 카테고리/상품관리 &gt;<span>대카테고리별 추천상품</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<!-- 페이지 타이틀 -->
					<div class="title_depth3">대카테고리별 추천상품</div>
					<!-- 소제목 -->
            ...
            <tr>
				...
				<?php
								...
								echo "<select name=code_b style=\"width:170px;display:none;\" onchange=\"SearchChangeCate(this,2)\">\n";
								echo "<option value=\"\">〓〓 2차 카테고리 〓〓</option>\n";
								echo "</select>\n";

								echo "<select name=code_c style=\"width:170px;display:none;\" onchange=\"SearchChangeCate(this,3)\">\n";
		...
		?>
							...
							<?
								...
								/*if($serial_value){
									...
									$iframeSrc = "product_hotitemlist.main.php?inCateCode=".$inCateCode;
								/*}*/
							?>
