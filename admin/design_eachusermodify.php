...
if($type=="update" && ord($body)) {
	...
	$onload="<script>window.onload=function(){ alert(\"회원정보수정 화면 디자인 수정이 완료되었습니다.\"); }</script>";
} elseif($type=="delete") {
	...
	pmysql_query($sql,get_db_conn());
	DeleteCache("tblshopinfo.cache");
	$onload="<script>window.onload=function(){ alert(\"회원정보수정 화면 디자인 삭제가 완료되었습니다.\"); }</script>";
} elseif($type=="clear") {
	$intitle="";
	$body="";
...
function CheckForm(type) {
	if(type=="update") {
		...
		if(confirm("회원정보수정 화면 디자인을 삭제하시겠습니까?")) {
			document.form1.type.value=type;
			document.form1.submit();
		}
	} else if(type=="clear") {
...
<div class="admin_linemap"><div class="line"><p>현재위치 : 디자인관리 &gt; 개별디자인-페이지 본문 &gt;<span>회원수정화면 꾸미기</span></p></div></div>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td>
                    <!-- 페이지 타이틀 -->
					<div class="title_depth3">회원수정 화면 꾸미기</div>
					<div class="title_depth3_sub"><span>회원정보수정 화면 디자인을 자유롭게 디자인 하실 수 있습니다.</span></div>
                </td>
            </tr>
            <tr>
            	<td>
					<!-- 소제목 -->
					<div class="title_depth3_sub">회원정보수정 화면 개별디자인</div>              
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
					...
					<div class="sub_manual_wrap">
						...
						<dl>
							<dt><span class="point_c1">회원수정 매크로명령어</span><span>(해당 매크로명령어는 다른 페이지 디자인 작업시 사용이 불가능함)</span></dt>
							<dd>
						...
						<tr>
							...
							<td class=td_con1 style="padding-left:5;">
							집주소 우편번호검색 버튼 <FONT class=font_blue>(예:&lt;a href=[GETHPOST]>우편번호검색&lt;/a>)</font>
							</td>
						</tr>
						<tr><td colspan=2 height=1 bgcolor=#dddddd></td></tr>
						<tr>
						...
						<tr>
							...
							<td class=td_con1 style="padding-left:5;">
							회사주소 우편번호검색 버튼 <FONT class=font_blue>(예:&lt;a href=[GETHPOST]>우편번호검색&lt;/a>)</font>
							</td>
						</tr>
						<tr><td colspan=2 height=1 bgcolor=#dddddd></td></tr>
						<tr>
						...
						<tr>
							...
							<td class=td_con1 style="padding-left:5;">
							개별 추가입력폼 - <FONT class=font_blue>(예:하고싶은말 : [ETCFIELD1])</font>
							</td>
						</tr>
						<tr><td colspan=2 height=1 bgcolor=#dddddd></td></tr>
						<tr>
						...
						<tr>
							...
							<td class=td_con1 style="padding-left:5;">
							취소버튼 <FONT class=font_blue>(예:&lt;a href=[CANCEL]>취소&lt;/a>)</font>
							</td>
						</tr>
						<tr><td colspan=2 height=1 bgcolor=#dddddd></td></tr>
						<tr>
							...
							<td class=td_con1 style="padding-left:5;">
							회원탈퇴버튼 <FONT class=font_blue>(예:&lt;a href=[MEMBEROUT]>회원탈퇴&lt;/a>)</font>
							</td>
						</tr>
						<tr><td colspan=2 height=1 bgcolor=#dddddd></td></tr>
						</table>
