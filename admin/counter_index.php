					...
					<tr>
						<td valign="top">
							<table cellpadding="0" cellspacing="0" width="354">
								<tr>
									<td width="390">
										<IMG SRC="images/counter_main_img1.gif" WIDTH=354 HEIGHT=29 ALT="">
									</td>
								</tr>
								<tr>
														...
														<tr>
															<td width="344" background="images/counter_main_bg.gif" style="padding:10pt;">
																<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
																	<TR>
																		<TD background="images/table_top_line1.gif" width="760" colspan="3">
																			<img src="images/table_top_line1.gif" width="13" height="2">
																		</TD>
																	</TR>
																	<TR>
																	...
																	<TR>
																		<TD colspan="3" width="760" background="images/table_con_line.gif">
																			<img src="images/table_con_line.gif" width="4" height="1" border="0">
																		</TD>
																	</TR>
																	<?php
											...
											<tr>
												<td width="344">
													<table cellpadding="0" cellspacing="0" width="326" align="center">
														<tr>
															<td width="344">
																<IMG SRC="images/counter_main_stitle1.gif" WIDTH=326 HEIGHT=17 ALT="">
															</td>
														</tr>
														<?php
...
?>
															...
															<tr>
																<td width="344">
																	<IMG SRC="images/counter_main_stitle2.gif" WIDTH=327 HEIGHT=18 ALT="">
																</td>
															</tr>
															<?php
...
?>
																...
																<tr>
																	<td width="344">
																		<IMG SRC="images/counter_main_stitle3.gif" WIDTH=328 HEIGHT=18 ALT="">
																	</td>
																</tr>
																<?php
							$sql ="SELECT SUBSTR(date,1,8) as mon,SUM(cnt) as cnt FROM tblcounter
...
?>
								...
								<tr>
									<td width="390">
										<IMG SRC="images/counter_main_imgdown.gif" WIDTH=354 HEIGHT=24 ALT="">
									</td>
								</tr>
							</table>
						</td>
						...
						<td valign="top">
							<table cellpadding="0" cellspacing="0" width="354">
								<tr>
									<td width="390">
										<IMG SRC="images/counter_main_img2.gif" WIDTH=354 HEIGHT=29 ALT="">
									</td>
								</tr>
								<tr>
									<td width="390" background="images/counter_main_imgbg.gif">
														...
														<tr>
															<td width="344" background="images/counter_main_bg.gif" style="padding:10pt;">
																<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
																	...
																	<TR>
																		<TD colspan="3" background="images/table_con_line.gif">
																			<img src="images/table_con_line.gif" width="4" height="1" border="0">
																		</TD>
																	</TR>
																	<?php
											...
											<tr>
												<td>
													<table cellpadding="0" cellspacing="0" width="326" align="center">
														<tr>
															<td width="344">
																<IMG SRC="images/counter_main_stitle4.gif" WIDTH=326 HEIGHT=17 ALT="">
															</td>
														</tr>
														<?php
...
?>
															...
															<tr>
																<td width="344">
																	<IMG SRC="images/counter_main_stitle5.gif" WIDTH=327 HEIGHT=18 ALT="">
																</td>
															</tr>
															<?php
...
?>
																...
																<tr>
																	<td width="344">
																		<IMG SRC="images/counter_main_stitle6.gif" WIDTH=328 HEIGHT=18 ALT="">
																	</td>
																</tr>
																<?php
							$sql ="SELECT SUBSTR(date,1,8) as mon,SUM(cnt) as cnt FROM tblcounterorder
		...
		<tr>
			<td>
				<div class="sub_manual_wrap">
					...
					<dl>
						<dt>
							<span>시간 흐름(일/주간/월간)에 따른 순방문자/페이지뷰/주문시도건수를 그래프로 한눈에 볼 수 있습니다.</span>
						</dt>
					</dl>
					<dl>
						<dt>
							<span>시간 흐름에 따른 쇼핑몰 중요 데이터를 그림으로 쉽게 분석할 수 있습니다.</span>
						</dt>
					</dl>
					<dl>
						<dt>
							<span>하루 하루 나타나는 데이터를 출력하여 모아 놓으면, 아주 소중한 쇼핑몰 운영가이드책이 될 수 있습니다.</span>
						</dt>
					</dl>
				</div>
