...
<div class="content-wrap">
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td>
				...
				<div class="title_depth3_sub">
					<span>결제일자별, 환불일자별 정산내역을 확인하실 수 있습니다.</span>
				</div>
			</td>
		</tr>
		...
		<tr>
			<td>
				<!-- 소제목 -->
				<div class="title_depth3_sub">품목별 조회</span>
				</div>
			</td>
		</tr>
...
?>
								<tr bgcolor=<?=$thiscolor?> onmouseover="this.style.background='#FEFBD1'" onmouseout="this.style.background='
									<?=$thiscolor?>'">
										...
										<td>
											<A HREF="javascript:OrderDetailView('<?=$ordercode?>')">
												<?=$ordercode?>
											</a>
										</td>
										...
										<td align=right>
											<?=number_format($op_coupon)?>
										</td>
										<td align=right>
											<?=number_format($op_usepoint)?>
										</td>
										<td align=right>
											<?=number_format($op_useepoint)?>
										</td>
										<td align=right>
											<?=number_format($op_reserve)?>
										</td>
										<td align=right>
											<?=$order_gubun?>
										</td>
										<td align=right>
											<?=number_format($option_quantity)?>
										</td>
										<td align=right>
